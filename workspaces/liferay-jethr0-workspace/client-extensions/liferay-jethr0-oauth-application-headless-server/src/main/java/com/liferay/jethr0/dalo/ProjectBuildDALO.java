 ...
 */
@Configuration
public class ProjectBuildDALO extends BaseRelationshipDALO {

	public JSONObject createRelationship(Project project, Build build) {
		return create("/o/c/projects", project.getId(), build.getId());
	}

	public JSONObject deleteRelationship(Project project, Build build) {
		return delete("/o/c/projects", project.getId(), build.getId());
	}
