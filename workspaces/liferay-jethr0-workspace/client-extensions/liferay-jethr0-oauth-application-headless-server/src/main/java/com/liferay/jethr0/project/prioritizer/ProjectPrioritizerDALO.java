...
public class ProjectPrioritizerDALO extends ObjectDALO {
	...
	public ProjectPrioritizer createProjectPrioritizer(String name) {
		...
		return new DefaultProjectPrioritizer(responseJSONObject);
	}
	...
	public ProjectPrioritizer updateProjectPrioritizer(
		...
		requestJSONObject.put("id", projectPrioritizer.getID());
		requestJSONObject.put("name", projectPrioritizer.getName());

		projectPrioritizer = new DefaultProjectPrioritizer(
			update(requestJSONObject));
	...
	protected String getObjectURLPath() {
		return "/o/c/projectprioritizers";
	}
