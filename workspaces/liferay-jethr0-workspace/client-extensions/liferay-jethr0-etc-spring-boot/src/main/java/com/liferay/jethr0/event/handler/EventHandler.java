...
public interface EventHandler {
	...
	public enum EventType {
		...
		CREATE_JOB, GITHUB_ACTION_CREATED, GITHUB_ACTION_DELETED,
		GITHUB_ACTION_EDITED, GITHUB_ACTION_LABELED, GITHUB_ACTION_UNLABELED,
		GITHUB_BRANCH_PUSH, GITHUB_COMMIT, QUEUE_ITEM_ENTER_BLOCKED,
