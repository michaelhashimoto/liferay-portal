 ...
 */
@Component(
	property = "resource.locator.key=/headless-admin-workflow/v1.0/WorkflowDefinitionLink",
	service = WorkflowDefinitionLinkResource.Factory.class
)
@Generated("")
public class WorkflowDefinitionLinkResourceFactoryImpl
	implements WorkflowDefinitionLinkResource.Factory {

	@Override
	public WorkflowDefinitionLinkResource.Builder create() {
		return new WorkflowDefinitionLinkResource.Builder() {
			...
			public WorkflowDefinitionLinkResource build() {
				...
				Function<InvocationHandler, WorkflowDefinitionLinkResource>
					workflowDefinitionLinkResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_workflowDefinitionLinkResourceProxyProviderFunction;

				return workflowDefinitionLinkResourceProxyProviderFunction.
					apply(
			...
			@Override
			public WorkflowDefinitionLinkResource.Builder checkPermissions(
			...
			@Override
			public WorkflowDefinitionLinkResource.Builder httpServletRequest(
			...
			@Override
			public WorkflowDefinitionLinkResource.Builder httpServletResponse(
			...
			@Override
			public WorkflowDefinitionLinkResource.Builder preferredLocale(
			...
			@Override
			public WorkflowDefinitionLinkResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public WorkflowDefinitionLinkResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, WorkflowDefinitionLinkResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			WorkflowDefinitionLinkResource.class.getClassLoader(),
			WorkflowDefinitionLinkResource.class);

		try {
			Constructor<WorkflowDefinitionLinkResource> constructor =
				(Constructor<WorkflowDefinitionLinkResource>)
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function
			<InvocationHandler, WorkflowDefinitionLinkResource>
				_workflowDefinitionLinkResourceProxyProviderFunction =
					_getProxyProviderFunction();
