 ...
 */
@Generated("")
@GraphQLName("AssignStructureDefaultWorkflowBulkAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "AssignStructureDefaultWorkflowBulkAction")
public class AssignStructureDefaultWorkflowBulkAction
	...
	public static AssignStructureDefaultWorkflowBulkAction toDTO(String json) {
		return ObjectMapperUtil.readValue(
			AssignStructureDefaultWorkflowBulkAction.class, json);
	}

	public static AssignStructureDefaultWorkflowBulkAction unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.AssignStructureDefaultWorkflowBulkAction",
		name = "x-class-name"
	)
