...
public class Variable implements Serializable {
	...
	public static Variable toDTO(String json) {
		return ObjectMapperUtil.readValue(Variable.class, json);
	}

	public static Variable unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Variable.class, json);
	}
