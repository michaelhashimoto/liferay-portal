	...
	protected List<BatchTestClassGroup> getBatchTestClassGroups(
		...
		System.out.println(
			JenkinsResultsParserUtil.combine(
				...
				" Started creating batch test class groups"));
					...
					private BatchTestClassGroup _call() throws Exception {
						...
						System.out.println(
							JenkinsResultsParserUtil.combine(
								JenkinsResultsParserUtil.toDateString(
									new Date(start), "America/Los_Angeles"),
								" Started creating batch test class group ",
								batchName));
						...
						System.out.println(
							JenkinsResultsParserUtil.combine(
								...
								" Completed batch test class group ", batchName,
								" in ",
		...
		System.out.println(
			JenkinsResultsParserUtil.combine(
				JenkinsResultsParserUtil.toDateString(
					new Date(), "America/Los_Angeles"),
				" Completed batch test class groups in ",
				JenkinsResultsParserUtil.toDurationString(
					System.currentTimeMillis() - start)));
