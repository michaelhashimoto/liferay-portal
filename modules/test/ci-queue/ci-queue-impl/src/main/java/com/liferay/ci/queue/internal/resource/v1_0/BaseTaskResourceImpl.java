...
public abstract class BaseTaskResourceImpl implements TaskResource {
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/ci-queue/v1.0/task'  -u 'test@liferay.com:test'
	 */
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/ci-queue/v1.0/tasks'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "Task")}
	)
