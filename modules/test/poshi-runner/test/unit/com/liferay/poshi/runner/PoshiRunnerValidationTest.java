...
public class PoshiRunnerValidationTest extends TestCase {
	...
	public void testGetPrimaryAttributeName() {
		...
		String primaryAttributeName =
			PoshiRunnerValidation.getPrimaryAttributeName(
				element, Arrays.asList("function", "selenium"), null);
	...
	public void testParseElements() {
		String filePath = _getFilePath("ParseElements.macro");

		Element element = PoshiRunnerContext.getMacroCommandElement(
			"ParseElements#parseElementPass");

		PoshiRunnerValidation.parseElements(element, filePath);

		Assert.assertEquals(
			"parseElements is failing", "", _getExceptionMessage());

		PoshiRunnerValidation.clearExceptions();

		element = PoshiRunnerContext.getMacroCommandElement(
			"ParseElements#parseElementFail");

		PoshiRunnerValidation.parseElements(element, filePath);

		Assert.assertEquals(
			"parseElements is failing", "Invalid contains element",
	...
	public void testValidateCommandElement() {
		...
		PoshiRunnerValidation.validateCommandElement(element, null);
	...
	public void testValidateConditionElement() {
		...
		PoshiRunnerValidation.validateConditionElement(element, null);
	...
	public void testValidateElementName() {
		...
		PoshiRunnerValidation.validateElementName(
			element, possibleElementNames, null);
	...
	public void testValidateElseElement() {
		...
		PoshiRunnerValidation.validateElseElement(element, null);
	...
	public void testValidateElseIfElement() {
		...
		PoshiRunnerValidation.validateElseIfElement(element, null);
	...
	public void testValidateExecuteElement() {
		...
		PoshiRunnerValidation.validateExecuteElement(element, null);
	...
	public void testValidateForElement() {
		...
		PoshiRunnerValidation.validateForElement(element, null);
	...
	public void testValidateFunctionFile() throws Exception {
		String filePath = _getFilePath("Close.function");

		Element rootElement = PoshiRunnerGetterUtil.getRootElementFromFilePath(
			filePath);

		PoshiRunnerValidation.validateFunctionFile(rootElement, filePath);
		...
		filePath = _getFilePath("Open.function");
	...
	public void testValidateHasChildElements() {
		...
		PoshiRunnerValidation.validateHasChildElements(element, null);
	...
	public void testValidateHasNoAttributes() {
		...
		PoshiRunnerValidation.validateHasNoAttributes(element, null);
	...
	public void testValidateHasNoChildElements() {
		...
		PoshiRunnerValidation.validateHasNoChildElements(element, null);
	...
	public void testValidateHasPrimaryAttributeName() {
		...
		PoshiRunnerValidation.validateHasPrimaryAttributeName(
			element, Arrays.asList("function", "macro"), null);
		...
		PoshiRunnerValidation.validateHasPrimaryAttributeName(
			...
			Arrays.asList("function", "selenium"), null);
	...
	public void testValidateMacroContext() {
		...
		PoshiRunnerValidation.validateMacroContext(element, "macro", null);
	...
	public void testValidateMacroFile() throws Exception {
		...
		PoshiRunnerValidation.validateMacroFile(rootElement, filePath);
		...
		filePath = _getFilePath("ParseElements.macro");
	...
	public void testValidateMessageElement() {
		...
		PoshiRunnerValidation.validateMessageElement(element, null);
	...
	public void testValidateNumberOfAttributes() {
		...
		PoshiRunnerValidation.validateNumberOfAttributes(element, 2, null);
		...
		PoshiRunnerValidation.validateNumberOfAttributes(element, 1, null);
		...
		PoshiRunnerValidation.validateNumberOfAttributes(element, 3, null);
	...
	public void testValidateNumberOfChildElements() {
		...
		PoshiRunnerValidation.validateNumberOfChildElements(element, 1, null);
		...
		PoshiRunnerValidation.validateNumberOfChildElements(element, 2, null);
	...
	public void testValidatePossibleAttributeNames() {
		...
		PoshiRunnerValidation.validatePossibleAttributeNames(
			element, Arrays.asList("function", "locator1", "value1"), null);
	...
	public void testValidatePropertyElement() {
		...
		PoshiRunnerValidation.validatePropertyElement(element, null);
	...
	public void testValidateRequiredAttributeNames() {
		...
		PoshiRunnerValidation.validateRequiredAttributeNames(
			element, Arrays.asList("line-number", "name", "value"), null);
	...
	public void testValidateRequiredChildElementName() {
		...
		PoshiRunnerValidation.validateRequiredChildElementName(
			element, requiredChildElementName, null);
	...
	public void testValidateRequiredChildElementNames() {
		...
		PoshiRunnerValidation.validateRequiredChildElementNames(
			element, Arrays.asList("condition", "contains"), null);
		...
		PoshiRunnerValidation.validateRequiredChildElementNames(
			element, Arrays.asList("condition", "contains", "equals"), null);
	...
	@Test
	public void testValidateTakeScreenshotElement() {
		Document document = DocumentHelper.createDocument();

		Element element = document.addElement("take-screenshot");

		PoshiRunnerValidation.validateTakeScreenshotElement(element, null);

		Assert.assertEquals(
			"validateTakeScreenshotElement is failing", "",
			_getExceptionMessage());
	}

	@Test
	public void testValidateTaskElement() {
		Document document = DocumentHelper.createDocument();

		Element element = document.addElement("task");

		element.addAttribute("summary", "Add a portlet");
		...
		PoshiRunnerValidation.validateTaskElement(element, null);

		Assert.assertEquals(
			"validateTaskElement is failing", "", _getExceptionMessage());
	}

	@Test
	public void testValidateTestCaseContext() throws Exception {
		Element element = PoshiRunnerContext.getTestCaseCommandElement(
			"ValidateTestCaseContext#testCaseContext");

		List<Element> executeElements = element.elements("execute");

		for (Element executeElement : executeElements) {
			PoshiRunnerValidation.validateTestCaseContext(
				executeElement,
				_getFilePath("ValidateTestCaseContext.testcase"));
		}

		Assert.assertEquals(
			"validateTestCaseContext is failing", "", _getExceptionMessage());
	...
	public void testValidateThenElement() {
		...
		PoshiRunnerValidation.validateThenElement(element, null);
	...
	public void testValidateVarElement() {
		...
		PoshiRunnerValidation.validateVarElement(element, null);
	...
	public void testValidateWhileElement() {
		...
		PoshiRunnerValidation.validateWhileElement(element, null);
