...
public class AddFrontPageChildPage3Test extends BaseTestCase {
	public void testAddFrontPageChildPage3() throws Exception {
		...
		selenium.type("//input[@id='_36_title']",
			RuntimeVariables.replace("Wiki3 Front3 Page3 Child3 Page3 Title3"));
		selenium.saveScreenShotAndSource();
		Thread.sleep(5000);
		...
		selenium.type("//body",
			RuntimeVariables.replace("Wiki3 Front3 Page3 Child3 Page3 Content3"));
		...
		assertEquals(RuntimeVariables.replace(
				"Wiki3 Front3 Page3 Child3 Page3 Title3"),
		...
		assertEquals(RuntimeVariables.replace(
				"Wiki3 Front3 Page3 Child3 Page3 Content3"),
