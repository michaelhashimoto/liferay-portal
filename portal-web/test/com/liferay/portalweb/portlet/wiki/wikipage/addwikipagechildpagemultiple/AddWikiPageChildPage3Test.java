...
public class AddWikiPageChildPage3Test extends BaseTestCase {
	public void testAddWikiPageChildPage3() throws Exception {
		...
		selenium.type("//input[@id='_36_title']",
			RuntimeVariables.replace("Wiki3 Page3 Child3 Page3 Title3"));
		selenium.saveScreenShotAndSource();
		Thread.sleep(5000);
		...
		selenium.type("//body",
			RuntimeVariables.replace("Wiki3 Page3 Child3 Page3 Content3"));
		...
		assertEquals(RuntimeVariables.replace("Wiki2 Page2 Child2 Page2 Title2"),
			selenium.getText("xPath=(//div[@class='child-pages']/ul/li/a)[2]"));
		assertEquals(RuntimeVariables.replace("Wiki3 Page3 Child3 Page3 Title3"),
		...
		assertEquals(RuntimeVariables.replace(
				"Wiki3 Page3 Child3 Page3 Content3"),
