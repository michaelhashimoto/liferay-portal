 ...
 */
public class AddFrontPageCreoleImageTest extends BaseTestCase {
	public void testAddFrontPageCreoleImage() throws Exception {
		...
		selenium.type("//td[@id='cke_contents__36_editor']/textarea",
			RuntimeVariables.replace("{{Wiki_Attachment.jpg}}"));
		selenium.saveScreenShotAndSource();
		selenium.clickAt("//span[@id='cke_34_label']",
			RuntimeVariables.replace("Source"));
		Thread.sleep(5000);
