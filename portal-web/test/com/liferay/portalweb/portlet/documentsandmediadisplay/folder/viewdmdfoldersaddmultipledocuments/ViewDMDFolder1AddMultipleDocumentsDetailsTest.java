 ...
 */
public class ViewDMDFolder1AddMultipleDocumentsDetailsTest extends BaseTestCase {
	public void testViewDMDFolder1AddMultipleDocumentsDetails()
		throws Exception {
		...
		selenium.clickAt("//div[@id='documentLibraryDisplayFoldersListingPanel']/div/div/div/div/table/tbody/tr[3]/td/a[2]",
			RuntimeVariables.replace("DMD Folder1 Name"));
		selenium.waitForPageToLoad("30000");
		loadRequiredJavaScriptModules();
