 ...
 */
public class User_PublishToRemoteLiveNowSPVariationChristmasTest
	extends BaseTestCase {
	public void testUser_PublishToRemoteLiveNowSPVariationChristmas()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				assertEquals(RuntimeVariables.replace(
						"Publish Christmas to Remote Live now."),
					selenium.getText(
						"//div[@class='lfr-component lfr-menu-list']/ul/li[1]/a"));
