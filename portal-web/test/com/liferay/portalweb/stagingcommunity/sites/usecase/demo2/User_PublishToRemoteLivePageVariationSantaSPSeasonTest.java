 ...
 */
public class User_PublishToRemoteLivePageVariationSantaSPSeasonTest
	extends BaseTestCase {
	public void testUser_PublishToRemoteLivePageVariationSantaSPSeason()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 3:
				...
				assertEquals(RuntimeVariables.replace(
						"Publish Season to Remote Live now."),
					selenium.getText(
						"//div[@class='lfr-component lfr-menu-list']/ul/li[1]/a"));
