 ...
 */
public class User_PublishToRemoteLiveNowSPVariationValentinesTest
	extends BaseTestCase {
	public void testUser_PublishToRemoteLiveNowSPVariationValentines()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				assertEquals(RuntimeVariables.replace(
						"Publish Valentines to Remote Live now."),
					selenium.getText(
						"//div[@class='lfr-component lfr-menu-list']/ul/li[1]/a"));
