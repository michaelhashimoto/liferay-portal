 ...
 */
public class User_PublishToRemoteLiveNowWCDSiteStagingTest extends BaseTestCase {
	public void testUser_PublishToRemoteLiveNowWCDSiteStaging()
		throws Exception {
		int label = 1;
