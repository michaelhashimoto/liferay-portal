 ...
 */
public class ActivateRemoteStagingCommunitySiteTest extends BaseTestCase {
	public void testActivateRemoteStagingCommunitySite()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.clickAt("//div[@id='dockbar']/ul[2]/li/a/span",
				...
				for (int second = 0;; second++) {
					...
					try {
						if (selenium.isVisible("//input[@id='_165_remote']")) {
							break;
						}
					}
					catch (Exception e) {
				...
				selenium.clickAt("//input[@id='_165_remote']",
					RuntimeVariables.replace("Remote Live"));
				...
				selenium.type("//input[@id='_165_remoteAddress']",
					RuntimeVariables.replace("192.168.95.41"));
				selenium.type("//input[@id='_165_remotePort']",
					RuntimeVariables.replace("8080"));
				selenium.type("//input[@id='_165_remoteGroupId']",
