 ...
 */
public class AssignRoleSiteAdministratorUserTest extends BaseTestCase {
	public void testAssignRoleSiteAdministratorUser() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Site Administrator"),
			selenium.getText("//tr/td/a"));
		selenium.clickAt("//tr/td/a",
