 ...
 */
public class AddRemoteSiteTest extends BaseTestCase {
	public void testAddRemoteSite() throws Exception {
		...
		selenium.type("//textarea[@id='_134_description']",
			RuntimeVariables.replace("This is the remote site description."));
