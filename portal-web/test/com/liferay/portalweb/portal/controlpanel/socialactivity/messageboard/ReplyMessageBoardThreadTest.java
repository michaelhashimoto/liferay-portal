 ...
 */
public class ReplyMessageBoardThreadTest extends BaseTestCase {
	public void testReplyMessageBoardThread() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		loadRequiredJavaScriptModules();
		selenium.clickAt("//a[@id='_19_ivtm']/span",
		...
		assertEquals(RuntimeVariables.replace("Root Thread Reply"),
