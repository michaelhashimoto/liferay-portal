 ...
 */
public class CheckinDMDocumentTest extends BaseTestCase {
	@Override
	...
	public void test() throws Exception {
		...
		cPDocumentsAndMediaDocumentMacros.checkin("DM Document Title",
			"DM Document Title Edit");
		gotoMacros.controlPanelPortlet("Documents and Media");
		cPDocumentsAndMediaHomeActions.click("DOCUMENT_NAME",
			"DM Document Title Edit");
		cPDocumentsAndMediaDocumentActions.assertElementNotPresent("DOCUMENT_LOCK_MESSAGE",
			null);
		cPDocumentsAndMediaDocumentActions.assertTextEquals("TOOLBAR_CHECKOUT",
			"Checkout");
