 ...
 */
public class AddDMDocumentTypeTest extends BaseTestCase {
	@Override
	...
	public void test() throws Exception {
		...
		cPDocumentsAndMediaHomeActions.assertTextEquals("//a[contains(.,'DM DocumentType Name') and @role='menuitem']",
