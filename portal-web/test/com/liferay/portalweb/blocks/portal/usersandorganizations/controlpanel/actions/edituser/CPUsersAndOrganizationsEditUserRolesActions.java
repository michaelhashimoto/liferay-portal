...
import com.liferay.portalweb.blocks.portal.usersandorganizations.controlpanel.paths.edituser.CPUsersAndOrganizationsEditUserRolesPaths;
import com.liferay.portalweb.portal.util.liferayselenium.LiferaySelenium;

/**
 * @author Brian Wing Shun Chan
 */
public class CPUsersAndOrganizationsEditUserRolesActions extends BaseActionsImpl
	implements LiferayActions {
	public CPUsersAndOrganizationsEditUserRolesActions(
		LiferaySelenium liferaySelenium) {
		super(liferaySelenium);
		paths = CPUsersAndOrganizationsEditUserRolesPaths.getPaths();
	}
