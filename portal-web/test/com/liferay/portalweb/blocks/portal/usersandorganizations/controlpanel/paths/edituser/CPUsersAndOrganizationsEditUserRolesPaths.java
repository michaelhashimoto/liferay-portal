...
package com.liferay.portalweb.blocks.portal.usersandorganizations.controlpanel.paths.edituser;
 ...
 */
public class CPUsersAndOrganizationsEditUserRolesPaths {
	public static Map<String, String[]> getPaths() {
		return _paths;
	}

	private static String[] _PAGE_NAME = {
			"", "Control Panel Users and Organizations Edit User Roles Page"
		};
	...
	private static String[] _REGULAR_ROLES_SELECT = {
			"//a[contains(@href,'_125_openRegularRoleSelector')]/span",
			"Select Regular Roles"
		};
	private static String[] _REGULAR_ROLES_FIRST_REGULAR_ROLE = {
			"//table[@data-searchcontainerid='_125_rolesSearchContainer']/tbody[1]/tr[3]/td[1]",
			"First Regular Role's Name"
		};
	private static String[] _REGULAR_ROLES_REMOVE_FIRST_REGULAR_ROLE = {
			"//table[@data-searchcontainerid='_125_rolesSearchContainer']/tbody[1]/tr[3]/td[2]/a/span/span",
			"Remove First Regular Role"
		};
	private static String[] _REGULAR_ROLES_SECOND_REGULAR_ROLE = {
			"//table[@data-searchcontainerid='_125_rolesSearchContainer']/tbody[1]/tr[4]/td[1]",
			"Second Regular Role's Name"
		};
	private static String[] _REGULAR_ROLES_REMOVE_SECOND_REGULAR_ROLE = {
			"//table[@data-searchcontainerid='_125_rolesSearchContainer']/tbody[1]/tr[4]/td[2]/a/span/span",
			"Remove Second Regular Role"
		};
	private static String[] _REGULAR_ROLES_THIRD_REGULAR_ROLE = {
			"//table[@data-searchcontainerid='_125_rolesSearchContainer']/tbody[1]/tr[5]/td[1]",
			"Third Regular Role's Name"
		};
	private static String[] _REGULAR_ROLES_REMOVE_THIRD_REGULAR_ROLE = {
			"//table[@data-searchcontainerid='_125_rolesSearchContainer']/tbody[1]/tr[5]/td[2]/a/span/span",
			"Remove Third Regular Role"
		};
	private static String[] _SITE_ROLES_SELECT = {
			"//a[contains(@href,'_125_openSiteRoleSelector')]/span",
			"Select Site Role"
		};
	private static String[] _SITE_ROLES_FIRST_SITE_ROLE_NAME = {
			"//table[@data-searchcontainerid='_125_siteRolesSearchContainer']/tbody[1]/tr[3]/td[1]",
			"First Site Role's Name"
		};
	private static String[] _SITE_ROLES_FIRST_SITE_ROLE_SITE = {
			"//table[@data-searchcontainerid='_125_siteRolesSearchContainer']/tbody[1]/tr[3]/td[2]",
			"First Site Role's Site"
		};
	private static String[] _SITE_ROLES_REMOVE_FIRST_SITE_ROLE = {
			"//table[@data-searchcontainerid='_125_siteRolesSearchContainer']/tbody[1]/tr[3]/td[3]/a/span/span",
			"Remove First Site Role"
		};
	private static String[] _SITE_ROLES_SECOND_SITE_ROLE_NAME = {
			"//table[@data-searchcontainerid='_125_siteRolesSearchContainer']/tbody[1]/tr[4]/td[1]",
			"Second Site Role's Name"
		};
	private static String[] _SITE_ROLES_SECOND_SITE_ROLE_SITE = {
			"//table[@data-searchcontainerid='_125_siteRolesSearchContainer']/tbody[1]/tr[4]/td[2]",
			"Second Site Role's Site"
		};
	private static String[] _SITE_ROLES_REMOVE_SECOND_SITE_ROLE = {
			"//table[@data-searchcontainerid='_125_siteRolesSearchContainer']/tbody[1]/tr[4]/td[3]/a/span/span",
			"Remove Second Site Role"
		};
	private static String[] _SITE_ROLES_THIRD_SITE_ROLE_NAME = {
			"//table[@data-searchcontainerid='_125_siteRolesSearchContainer']/tbody[1]/tr[5]/td[1]",
			"Third Site Role's Name"
		};
	private static String[] _SITE_ROLES_THIRD_SITE_ROLE_SITE = {
			"//table[@data-searchcontainerid='_125_siteRolesSearchContainer']/tbody[1]/tr[5]/td[2]",
			"Third Site Role's Site"
		};
	private static String[] _SITE_ROLES_REMOVE_THIRD_SITE_ROLE = {
			"//table[@data-searchcontainerid='_125_siteRolesSearchContainer']/tbody[1]/tr[5]/td[3]/a/span/span",
			"Remove Third Site Role"
		};
	...
	static {
		...
		_paths.put("REGULAR_ROLES_SELECT", _REGULAR_ROLES_SELECT);
		_paths.put("REGULAR_ROLES_FIRST_REGULAR_ROLE",
			_REGULAR_ROLES_FIRST_REGULAR_ROLE);
		_paths.put("REGULAR_ROLES_REMOVE_FIRST_REGULAR_ROLE",
			_REGULAR_ROLES_REMOVE_FIRST_REGULAR_ROLE);
		_paths.put("REGULAR_ROLES_SECOND_REGULAR_ROLE",
			_REGULAR_ROLES_SECOND_REGULAR_ROLE);
		_paths.put("REGULAR_ROLES_REMOVE_SECOND_REGULAR_ROLE",
			_REGULAR_ROLES_REMOVE_SECOND_REGULAR_ROLE);
		_paths.put("REGULAR_ROLES_THIRD_REGULAR_ROLE",
			_REGULAR_ROLES_THIRD_REGULAR_ROLE);
		_paths.put("REGULAR_ROLES_REMOVE_THIRD_REGULAR_ROLE",
			_REGULAR_ROLES_REMOVE_THIRD_REGULAR_ROLE);
		_paths.put("SITE_ROLES_SELECT", _SITE_ROLES_SELECT);
		_paths.put("SITE_ROLES_FIRST_SITE_ROLE_NAME",
			_SITE_ROLES_FIRST_SITE_ROLE_NAME);
		_paths.put("SITE_ROLES_FIRST_SITE_ROLE_SITE",
			_SITE_ROLES_FIRST_SITE_ROLE_SITE);
		_paths.put("SITE_ROLES_REMOVE_FIRST_SITE_ROLE",
			_SITE_ROLES_REMOVE_FIRST_SITE_ROLE);
		_paths.put("SITE_ROLES_SECOND_SITE_ROLE_NAME",
			_SITE_ROLES_SECOND_SITE_ROLE_NAME);
		_paths.put("SITE_ROLES_SECOND_SITE_ROLE_SITE",
			_SITE_ROLES_SECOND_SITE_ROLE_SITE);
		_paths.put("SITE_ROLES_REMOVE_SECOND_SITE_ROLE",
			_SITE_ROLES_REMOVE_SECOND_SITE_ROLE);
		_paths.put("SITE_ROLES_THIRD_SITE_ROLE_NAME",
			_SITE_ROLES_THIRD_SITE_ROLE_NAME);
		_paths.put("SITE_ROLES_THIRD_SITE_ROLE_SITE",
			_SITE_ROLES_THIRD_SITE_ROLE_SITE);
		_paths.put("SITE_ROLES_REMOVE_THIRD_SITE_ROLE",
			_SITE_ROLES_REMOVE_THIRD_SITE_ROLE);
