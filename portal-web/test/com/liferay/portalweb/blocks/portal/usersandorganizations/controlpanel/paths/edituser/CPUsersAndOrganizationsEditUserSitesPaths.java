 ...
 */
public class CPUsersAndOrganizationsEditUserSitesPaths {
	public static Map<String, String[]> getPaths() {
		return _paths;
	}

	private static String[] _PAGE_NAME = {
			"", "Control Panel Users and Organizations Edit User Sites Page"
		};
	...
	private static String[] _SITES_SELECT = {
			"//div[@id='_125_sites']/span/a/span", "Select Sites"
		};
	private static String[] _SITES_FIRST_SITE_NAME = {
			"//table[@data-searchcontainerid='_125_groupsSearchContainer']/tr[1]/td[1]",
			"First Site's Name"
		};
	private static String[] _SITES_FIRST_SITE_ROLES = {
			"//table[@data-searchcontainerid='_125_groupsSearchContainer']/tr[1]/td[2]",
			"First Site Roles"
		};
	private static String[] _SITES_FIRST_SITE_REMOVE = {
			"//table[@data-searchcontainerid='_125_groupsSearchContainer']/tr[1]/td[3]/a/span/span",
			"Remove First Site Link"
		};
	private static String[] _SITES_SECOND_SITE_NAME = {
			"//table[@data-searchcontainerid='_125_groupsSearchContainer']/tr[2]/td[1]",
			"Second Site's Name"
		};
	private static String[] _SITES_SECOND_SITE_ROLES = {
			"//table[@data-searchcontainerid='_125_groupsSearchContainer']/tr[2]/td[2]",
			"Second Site Roles"
		};
	private static String[] _SITES_SECOND_SITE_REMOVE = {
			"//table[@data-searchcontainerid='_125_groupsSearchContainer']/tr[2]/td[3]/a/span/span",
			"Remove Second Site Link"
		};
	private static String[] _SITES_THIRD_SITE_NAME = {
			"//table[@data-searchcontainerid='_125_groupsSearchContainer']/tr[3]/td[1]",
			"Third Site's Name"
		};
	private static String[] _SITES_THIRD_SITE_ROLES = {
			"//table[@data-searchcontainerid='_125_groupsSearchContainer']/tr[3]/td[2]",
			"Third Site Roles"
		};
	private static String[] _SITES_THIRD_SITE_REMOVE = {
			"//table[@data-searchcontainerid='_125_groupsSearchContainer']/tr[3]/td[3]/a/span/span",
			"Remove Third Site Link"
		};
	...
	static {
		...
		_paths.put("SITES_SELECT", _SITES_SELECT);
		_paths.put("SITES_FIRST_SITE_NAME", _SITES_FIRST_SITE_NAME);
		_paths.put("SITES_FIRST_SITE_ROLES", _SITES_FIRST_SITE_ROLES);
		_paths.put("SITES_FIRST_SITE_REMOVE", _SITES_FIRST_SITE_REMOVE);
		_paths.put("SITES_SECOND_SITE_NAME", _SITES_SECOND_SITE_NAME);
		_paths.put("SITES_SECOND_SITE_ROLES", _SITES_SECOND_SITE_ROLES);
		_paths.put("SITES_SECOND_SITE_REMOVE", _SITES_SECOND_SITE_REMOVE);
		_paths.put("SITES_THIRD_SITE_NAME", _SITES_THIRD_SITE_NAME);
		_paths.put("SITES_THIRD_SITE_ROLES", _SITES_THIRD_SITE_ROLES);
		_paths.put("SITES_THIRD_SITE_REMOVE", _SITES_THIRD_SITE_REMOVE);
