 ...
 */
public class CPUsersAndOrganizationsEditUserPasswordPaths {
	public static Map<String, String[]> getPaths() {
		return _paths;
	}

	private static String[] _PAGE_NAME = {
			"", "Control Panel Users and Organizations Edit User Password Page"
		};
	...
	private static String[] _PASSWORD_NEW_PASSWORD = {
			"//input[@id='_125_password1']", "Password Field"
		};
	private static String[] _PASSWORD_ENTER_AGAIN = {
			"//input[@id='_125_password2']", "Reenter Password Field"
		};
	private static String[] _PASSWORD_PASSWORD_RESET_REQUIRED = {
			"//input[@id='_125_passwordResetCheckbox']",
	...
	static {
		...
		_paths.put("PASSWORD_NEW_PASSWORD", _PASSWORD_NEW_PASSWORD);
		_paths.put("PASSWORD_ENTER_AGAIN", _PASSWORD_ENTER_AGAIN);
		_paths.put("PASSWORD_PASSWORD_RESET_REQUIRED",
			_PASSWORD_PASSWORD_RESET_REQUIRED);
