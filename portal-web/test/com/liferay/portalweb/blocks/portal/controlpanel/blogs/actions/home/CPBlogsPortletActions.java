...
import com.liferay.portalweb.blocks.portal.controlpanel.blogs.paths.home.CPBlogsPortletPaths;
import com.liferay.portalweb.portal.util.liferayselenium.LiferaySelenium;

/**
 * @author Brian Wing Shun Chan
 */
public class CPBlogsPortletActions extends BaseActionsImpl
	implements LiferayActions {
	public CPBlogsPortletActions(LiferaySelenium liferaySelenium) {
		super(liferaySelenium);
		paths = CPBlogsPortletPaths.getPaths();
	}
