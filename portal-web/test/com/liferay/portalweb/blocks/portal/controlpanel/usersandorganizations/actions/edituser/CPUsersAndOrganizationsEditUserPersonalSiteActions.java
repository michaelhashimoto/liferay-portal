...
import com.liferay.portalweb.blocks.portal.controlpanel.usersandorganizations.paths.edituser.CPUsersAndOrganizationsEditUserPersonalSitePaths;
import com.liferay.portalweb.portal.util.liferayselenium.LiferaySelenium;

/**
 * @author Brian Wing Shun Chan
 */
public class CPUsersAndOrganizationsEditUserPersonalSiteActions
	extends BaseActionsImpl implements LiferayActions {
	public CPUsersAndOrganizationsEditUserPersonalSiteActions(
		LiferaySelenium liferaySelenium) {
		super(liferaySelenium);
		paths = CPUsersAndOrganizationsEditUserPersonalSitePaths.getPaths();
	}
