...
import com.liferay.portalweb.blocks.portal.controlpanel.usersandorganizations.paths.adduser.CPUsersAndOrganizationsAddUserPersonalSitePaths;
import com.liferay.portalweb.portal.util.liferayselenium.LiferaySelenium;

/**
 * @author Brian Wing Shun Chan
 */
public class CPUsersAndOrganizationsAddUserPersonalSiteActions
	extends BaseActionsImpl implements LiferayActions {
	public CPUsersAndOrganizationsAddUserPersonalSiteActions(
		LiferaySelenium liferaySelenium) {
		super(liferaySelenium);
		paths = CPUsersAndOrganizationsAddUserPersonalSitePaths.getPaths();
	}
