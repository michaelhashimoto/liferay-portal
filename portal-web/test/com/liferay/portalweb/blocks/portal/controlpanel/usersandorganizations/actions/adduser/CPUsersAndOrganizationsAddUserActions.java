...
import com.liferay.portalweb.blocks.portal.controlpanel.usersandorganizations.paths.adduser.CPUsersAndOrganizationsAddUserPaths;
import com.liferay.portalweb.portal.util.liferayselenium.LiferaySelenium;

/**
 * @author Brian Wing Shun Chan
 */
public class CPUsersAndOrganizationsAddUserActions extends BaseActionsImpl
	implements LiferayActions {
	public CPUsersAndOrganizationsAddUserActions(
		LiferaySelenium liferaySelenium) {
		super(liferaySelenium);
		paths = CPUsersAndOrganizationsAddUserPaths.getPaths();
	}
