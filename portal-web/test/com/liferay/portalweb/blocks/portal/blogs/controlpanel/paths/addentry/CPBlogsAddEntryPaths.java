...
package com.liferay.portalweb.blocks.portal.blogs.controlpanel.paths.addentry;
 ...
 */
public class CPBlogsAddEntryPaths {
	public static Map<String, String[]> getPaths() {
		return _paths;
	}

	private static String[] _PAGE_NAME = {
			"", "Control Panel Blogs Add Entry Page"
		};
	...
	private static String[] _CONTENT_FIELD_DISPLAY_DATE_AM_PM = {
			"_161_displayDateAmPm", "Entry Content Display Date AM/PM select"
		};
	...
	private static String[] _PORTLET_LINK_BREADCRUMB_3 = {
			...
			"Portlet 3rd BreadcrumbAdd Entry Link"
		};
