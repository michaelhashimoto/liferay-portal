...
import com.liferay.portalweb.blocks.controlpanel.webcontent.paths.CPWebContentEditWebContentPermissionsPaths;
import com.liferay.portalweb.portal.util.liferayselenium.LiferaySelenium;

/**
 * @author Brian Wing Shun Chan
 */
public class CPWebContentEditWebContentPermissionsActions
	extends BaseActionsImpl implements LiferayActions {
	public CPWebContentEditWebContentPermissionsActions(
		LiferaySelenium liferaySelenium) {
		super(liferaySelenium);
		paths = CPWebContentEditWebContentPermissionsPaths.getPaths();
	}
}