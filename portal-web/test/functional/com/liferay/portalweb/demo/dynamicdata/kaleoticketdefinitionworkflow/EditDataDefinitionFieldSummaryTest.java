...
public class EditDataDefinitionFieldSummaryTest extends BaseTestCase {
	public void testEditDataDefinitionFieldSummary() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Text"),
			selenium.getText(
				"//div[@class='aui-diagram-builder-canvas']/div/div[3]/div/label"));
		selenium.clickAt("//div[@class='aui-diagram-builder-canvas']/div/div[3]",
			RuntimeVariables.replace("Text"));
		selenium.waitForVisible("xPath=(//button[@id='editEvent'])[3]");
