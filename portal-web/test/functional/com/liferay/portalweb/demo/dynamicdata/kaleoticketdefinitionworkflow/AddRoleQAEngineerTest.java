 ...
 */
public class AddRoleQAEngineerTest extends BaseTestCase {
	public void testAddRoleQAEngineer() throws Exception {
		...
		selenium.type("//textarea[@id='_128_description_en_US']",
			RuntimeVariables.replace("This is the QA Engineer Role."));
