 ...
 */
public class AddPermissionsPUBlogsAcessInCPUPSTest extends BaseTestCase {
	public void testAddPermissionsPUBlogsAcessInCPUPS()
		throws Exception {
		...
		selenium.select("//select[@id='_128_add-permissions']",
			RuntimeVariables.replace("Blogs (Control Panel)"));
		selenium.waitForPageToLoad("30000");
