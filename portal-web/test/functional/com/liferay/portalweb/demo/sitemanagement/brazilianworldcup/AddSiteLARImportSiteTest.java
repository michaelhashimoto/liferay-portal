 ...
 */
public class AddSiteLARImportSiteTest extends BaseTestCase {
	public void testAddSiteLARImportSite() throws Exception {
		...
		selenium.type("//textarea[@id='_134_description']",
			RuntimeVariables.replace(
				"This is a site for importing the LAR files"));
