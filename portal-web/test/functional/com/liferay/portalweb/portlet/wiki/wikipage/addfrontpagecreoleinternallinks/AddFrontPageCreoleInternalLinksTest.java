 ...
 */
public class AddFrontPageCreoleInternalLinksTest extends BaseTestCase {
	public void testAddFrontPageCreoleInternalLinks() throws Exception {
		...
		selenium.waitForText("//body", "Link to a page");
		selenium.selectFrame("relative=top");
