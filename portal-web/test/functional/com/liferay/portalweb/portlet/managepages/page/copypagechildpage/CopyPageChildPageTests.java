...
import com.liferay.portalweb.portlet.managepages.page.addchildpage.AddChildPageTest;
 ...
 */
public class CopyPageChildPageTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageTest.class);
		testSuite.addTestSuite(AddChildPageTest.class);
		testSuite.addTestSuite(CopyPageChildPageTest.class);
