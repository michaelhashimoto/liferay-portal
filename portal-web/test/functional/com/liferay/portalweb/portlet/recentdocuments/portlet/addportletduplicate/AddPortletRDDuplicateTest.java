 ...
 */
public class AddPortletRDDuplicateTest extends BaseTestCase {
	public void testAddPortletRDDuplicate() throws Exception {
		...
		assertFalse(selenium.isVisible("//div[@title='Recent Downloads']/p/a"));
	}
}