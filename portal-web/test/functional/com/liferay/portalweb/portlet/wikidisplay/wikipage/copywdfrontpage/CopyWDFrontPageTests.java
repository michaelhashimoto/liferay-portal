 ...
 */
public class CopyWDFrontPageTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(CopyWDFrontPageTest.class);
		testSuite.addTestSuite(ViewCopyWDFrontPageTest.class);
