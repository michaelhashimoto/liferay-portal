 ...
 */
public class SearchMBCategoryThreadTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SearchMBCategoryThreadTest.class);
		testSuite.addTestSuite(SearchMBCategoryThreadQuotesTest.class);
