 ...
 */
public class SplitThreadMBCategoryThreadReplyTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SplitThreadMBCategoryThreadReplyTest.class);
		testSuite.addTestSuite(ViewSplitThreadMBCategoryThreadReplyTest.class);
