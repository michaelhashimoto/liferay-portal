 ...
 */
public class AddPageMBSiteTest extends BaseTestCase {
	public void testAddPageMBSite() throws Exception {
		...
		selenium.waitForVisible(
			"//ul[@class='aui-tree-container']/li/div/div/a[contains(.,'Message Boards Test Page')]");
