 ...
 */
public class DeleteBlogsEntryTitleEscapeCharactersTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageBlogsTest.class);
		testSuite.addTestSuite(AddPortletBlogsTest.class);
		testSuite.addTestSuite(AddBlogsEntryTitleEscapeCharactersTest.class);
		testSuite.addTestSuite(DeleteBlogsEntryTitleEscapeCharactersTest.class);
