 ...
 */
public class SearchBlogsEntryTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageBlogsTest.class);
		testSuite.addTestSuite(AddPortletBlogsTest.class);
		testSuite.addTestSuite(AddBlogsEntryTest.class);
		testSuite.addTestSuite(SearchBlogsEntryTest.class);
		testSuite.addTestSuite(SearchBlogsEntryQuotesTest.class);
