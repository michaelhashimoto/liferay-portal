 ...
 */
public class EditDMDocumentTypeTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageDMTest.class);
		testSuite.addTestSuite(AddPortletDMTest.class);
		testSuite.addTestSuite(AddDMDocumentTypeTest.class);
		testSuite.addTestSuite(EditDMDocumentTypeTest.class);
		testSuite.addTestSuite(ViewEditDMDocumentTypeTest.class);
