...
package com.liferay.portalweb.portlet.documentsandmedia.dmfolder.adddmfoldernameduplicate;
 ...
 */
public class AddDMFolderNameDuplicateTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageDMTest.class);
		testSuite.addTestSuite(AddPortletDMTest.class);
		testSuite.addTestSuite(AddDMFolderTest.class);
		testSuite.addTestSuite(AddDMFolderNameDuplicateTest.class);
