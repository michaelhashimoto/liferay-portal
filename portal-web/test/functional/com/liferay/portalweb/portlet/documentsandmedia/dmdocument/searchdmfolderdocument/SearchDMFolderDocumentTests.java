 ...
 */
public class SearchDMFolderDocumentTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SearchDMFolderDocumentTest.class);
		testSuite.addTestSuite(SearchDMFolderDocumentQuotesTest.class);
