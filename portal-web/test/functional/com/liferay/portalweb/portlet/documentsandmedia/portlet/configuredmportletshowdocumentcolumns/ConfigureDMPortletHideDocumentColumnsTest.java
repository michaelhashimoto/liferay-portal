 ...
 */
public class ConfigureDMPortletHideDocumentColumnsTest extends BaseTestCase {
	public void testConfigureDMPortletHideDocumentColumns()
		throws Exception {
		...
		selenium.waitForVisible("//select[@id='_86_currentEntryColumns']");
		...
		selenium.waitForPartialText("//select[@id='_86_availableEntryColumns']",
			"Name");
