 ...
 */
public class ConfigureDMPortletRemoveFolderTest extends BaseTestCase {
	public void testConfigureDMPortletRemoveFolder() throws Exception {
		...
		selenium.waitForNotText("//a[@id='_86_rootFolderName']",
			"DM Folder Name");
