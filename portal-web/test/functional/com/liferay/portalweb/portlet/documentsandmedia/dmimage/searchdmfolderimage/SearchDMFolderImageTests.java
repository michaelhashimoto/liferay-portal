 ...
 */
public class SearchDMFolderImageTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SearchDMFolderImageTest.class);
		testSuite.addTestSuite(SearchDMFolderImageQuotesTest.class);
