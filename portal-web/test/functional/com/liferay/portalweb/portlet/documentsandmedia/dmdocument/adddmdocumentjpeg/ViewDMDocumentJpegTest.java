 ...
 */
public class ViewDMDocumentJpegTest extends BaseTestCase {
	public void testViewDMDocumentJpeg() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Download (15.0k)"),
		...
		assertEquals(RuntimeVariables.replace("15.0k"),
