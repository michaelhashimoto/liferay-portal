 ...
 */
public class AddPortletCCTest extends BaseTestCase {
	public void testAddPortletCC() throws Exception {
		...
		selenium.keyUp("//input[@id='layout_configuration_content']",
			RuntimeVariables.replace("\\13"));
		selenium.waitForVisible("//div[@title='Currency Converter']/p/a");
		selenium.clickAt("//div[@title='Currency Converter']/p/a",
