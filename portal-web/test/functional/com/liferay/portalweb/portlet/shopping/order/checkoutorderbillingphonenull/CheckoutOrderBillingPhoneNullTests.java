 ...
 */
public class CheckoutOrderBillingPhoneNullTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(CheckoutOrderBillingPhoneNullTest.class);
		testSuite.addTestSuite(ViewCheckoutOrderBillingPhoneNullTest.class);
