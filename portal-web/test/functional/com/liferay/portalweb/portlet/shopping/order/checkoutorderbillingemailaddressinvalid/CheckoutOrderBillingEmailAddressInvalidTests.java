 ...
 */
public class CheckoutOrderBillingEmailAddressInvalidTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(CheckoutOrderBillingEmailAddressInvalidTest.class);
		testSuite.addTestSuite(ViewCheckoutOrderBillingEmailAddressInvalidTest.class);
