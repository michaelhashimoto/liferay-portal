 ...
 */
public class CheckoutOrderShippingStateInvalidTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(CheckoutOrderShippingStateInvalidTest.class);
		testSuite.addTestSuite(ViewCheckoutOrderShippingStateInvalidTest.class);
