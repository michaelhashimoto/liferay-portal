 ...
 */
public class CheckoutOrderCreditCardNumberInvalidDiscoverTest
	extends BaseTestCase {
	public void testCheckoutOrderCreditCardNumberInvalidDiscover()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				selenium.select("//select[@id='_34_ccType']",
					RuntimeVariables.replace("Discover"));
