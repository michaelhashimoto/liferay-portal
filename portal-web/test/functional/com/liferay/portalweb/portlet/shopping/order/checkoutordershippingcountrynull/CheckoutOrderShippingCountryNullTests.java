 ...
 */
public class CheckoutOrderShippingCountryNullTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(CheckoutOrderShippingCountryNullTest.class);
		testSuite.addTestSuite(ViewCheckoutOrderShippingCountryNullTest.class);
