 ...
 */
public class ViewCheckoutOrderCreditCardNumberInvalidVisaTest
	extends BaseTestCase {
	public void testViewCheckoutOrderCreditCardNumberInvalidVisa()
		throws Exception {
		...
		assertFalse(selenium.isTextPresent("1111111111111111"));
