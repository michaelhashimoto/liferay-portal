 ...
 */
public class CheckoutOrderShippingEmailAddressInvalidTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(CheckoutOrderShippingEmailAddressInvalidTest.class);
		testSuite.addTestSuite(ViewCheckoutOrderShippingEmailAddressInvalidTest.class);
