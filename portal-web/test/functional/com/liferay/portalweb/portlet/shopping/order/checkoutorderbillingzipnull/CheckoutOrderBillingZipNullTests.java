 ...
 */
public class CheckoutOrderBillingZipNullTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(CheckoutOrderBillingZipNullTest.class);
		testSuite.addTestSuite(ViewCheckoutOrderBillingZipNullTest.class);
