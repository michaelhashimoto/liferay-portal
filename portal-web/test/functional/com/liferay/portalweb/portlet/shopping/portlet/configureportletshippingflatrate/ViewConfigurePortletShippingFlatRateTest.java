 ...
 */
public class ViewConfigurePortletShippingFlatRateTest extends BaseTestCase {
	public void testViewConfigurePortletShippingFlatRate()
		throws Exception {
		...
		assertEquals("2.49", selenium.getValue("//input[@id='_86_shipping0']"));
		assertEquals("5.49", selenium.getValue("//input[@id='_86_shipping1']"));
		assertEquals("12.49", selenium.getValue("//input[@id='_86_shipping2']"));
		assertEquals("19.99", selenium.getValue("//input[@id='_86_shipping3']"));
		assertEquals("25.61", selenium.getValue("//input[@id='_86_shipping4']"));
		selenium.selectFrame("relative=top");
		selenium.open("/web/guest/home/");
		selenium.clickAt("link=Shopping Test Page",
			RuntimeVariables.replace("Shopping Test Page"));
