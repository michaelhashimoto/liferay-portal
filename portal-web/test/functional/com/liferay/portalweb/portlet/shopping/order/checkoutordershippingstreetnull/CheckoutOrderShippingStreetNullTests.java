 ...
 */
public class CheckoutOrderShippingStreetNullTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(CheckoutOrderShippingStreetNullTest.class);
		testSuite.addTestSuite(ViewCheckoutOrderShippingStreetNullTest.class);
