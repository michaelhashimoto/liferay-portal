 ...
 */
public class CheckoutOrderBillingFirstNameNullTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(CheckoutOrderBillingFirstNameNullTest.class);
		testSuite.addTestSuite(ViewCheckoutOrderBillingFirstNameNullTest.class);
