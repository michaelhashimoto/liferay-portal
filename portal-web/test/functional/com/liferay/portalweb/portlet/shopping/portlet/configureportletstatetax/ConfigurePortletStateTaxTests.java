 ...
 */
public class ConfigurePortletStateTaxTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ConfigurePortletStateTaxTest.class);
		testSuite.addTestSuite(ViewConfigurePortletStateTaxTest.class);
