 ...
 */
public class ViewAddCategoryItemNameNullTest extends BaseTestCase {
	public void testViewAddCategoryItemNameNull() throws Exception {
		...
		assertFalse(selenium.isTextPresent("1111"));
