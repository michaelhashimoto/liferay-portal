 ...
 */
public class CheckoutOrderCreditCardTypeNullTest extends BaseTestCase {
	public void testCheckoutOrderCreditCardTypeNull() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				assertEquals(RuntimeVariables.replace(
						"Please enter a valid credit card type."),
					selenium.getText(
