 ...
 */
public class CheckoutOrderBillingCountryNullTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(CheckoutOrderBillingCountryNullTest.class);
		testSuite.addTestSuite(ViewCheckoutOrderBillingCountryNullTest.class);
