 ...
 */
public class ViewCheckoutOrderBillingStateInvalidTest extends BaseTestCase {
	public void testViewCheckoutOrderBillingStateInvalid()
		throws Exception {
		...
		assertFalse(selenium.isTextPresent("Outside US"));
