 ...
 */
public class CheckoutOrderBillingCityNullTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(CheckoutOrderBillingCityNullTest.class);
		testSuite.addTestSuite(ViewCheckoutOrderBillingCityNullTest.class);
