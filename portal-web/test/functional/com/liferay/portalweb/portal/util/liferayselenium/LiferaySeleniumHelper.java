...
public class LiferaySeleniumHelper {
	...
	public static void sikuliAssertElementNotPresent(
		...
		Target target = getImageTarget(liferaySelenium, image);

		if (screenRegion.wait(target, 5000) != null) {
	...
	public static void sikuliAssertElementPresent(
		...
		screenRegion = screenRegion.wait(target, 5000);
	...
	public static void sikuliClick(
		...
		for (ScreenRegion sr : screenRegionList) {
	...
	public static void sikuliDragAndDrop(
		...
		screenRegion = screenRegion.find(target);
