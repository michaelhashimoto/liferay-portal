...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.phone.Phone527LatestTestPlan;
 ...
 */
public class DBUpgradePhone527LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new NamedTestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Phone527LatestTestPlan.suite());
