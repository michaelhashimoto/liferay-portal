 ...
 */
public class AddPermissionAddShortcutTest extends BaseTestCase {
	public void testAddPermissionAddShortcut() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				boolean addShortcut = selenium.isChecked(
