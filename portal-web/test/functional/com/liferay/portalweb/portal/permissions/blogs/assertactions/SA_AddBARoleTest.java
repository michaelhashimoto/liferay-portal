 ...
 */
public class SA_AddBARoleTest extends BaseTestCase {
	public void testSA_AddBARole() throws Exception {
		...
		selenium.type("//textarea[@id='_128_description_en_US']",
			RuntimeVariables.replace("This is the Blogs Administrator Role."));
