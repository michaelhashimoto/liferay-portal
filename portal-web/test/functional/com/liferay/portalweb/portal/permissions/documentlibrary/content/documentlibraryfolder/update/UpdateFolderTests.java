...
import com.liferay.portalweb.portal.permissions.documentlibrary.content.documentlibraryfolder.permissions.Member_AssertFolderActionsNotPresentTest;
 ...
 */
public class UpdateFolderTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AddPermissionUpdateDLFolderTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(Member_LoginTest.class);
		testSuite.addTestSuite(Member_AssertUpdateFolderTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(SignInTest.class);
