	...
	public void testAddPermissionAddToPage() throws Exception {
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.clickAt("//input[@value='20ADD_TO_PAGE']",
					RuntimeVariables.replace("Add To Page"));

			case 2:
				assertTrue(selenium.isChecked("//input[@value='20ADD_TO_PAGE']"));
