	...
	public void testAddPermissionPermissions() throws Exception {
		...
		while (label >= 1) {
			...
			case 1:
				...
				boolean accessToPermissions = selenium.isChecked(
						"//input[@value='20PERMISSIONS']");
				...
				selenium.clickAt("//input[@value='20PERMISSIONS']",
					RuntimeVariables.replace("Permissions Checkbox"));

			case 2:
				assertTrue(selenium.isChecked("//input[@value='20PERMISSIONS']"));
