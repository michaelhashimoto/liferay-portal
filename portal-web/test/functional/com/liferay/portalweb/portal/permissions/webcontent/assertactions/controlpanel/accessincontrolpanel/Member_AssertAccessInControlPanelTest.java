 ...
 */
public class Member_AssertAccessInControlPanelTest extends BaseTestCase {
	public void testMember_AssertAccessInControlPanel()
		throws Exception {
		...
		assertTrue(selenium.isVisible("link=Web Content"));
