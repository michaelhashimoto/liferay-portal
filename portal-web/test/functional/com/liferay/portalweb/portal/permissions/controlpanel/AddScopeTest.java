 ...
 */
public class AddScopeTest extends BaseTestCase {
	public void testAddScope() throws Exception {
		...
		selenium.select("_125_birthdayDay", RuntimeVariables.replace("label=31"));
		...
		selenium.waitForElementPresent("link=Scope");
