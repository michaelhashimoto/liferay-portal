...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.website.Website529LatestTestPlan;
 ...
 */
public class DBUpgradeWebsite529LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new NamedTestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Website529LatestTestPlan.suite());
