 ...
 */
public class AddVocabularyDisallowMultipleCategoriesTest extends BaseTestCase {
	public void testAddVocabularyDisallowMultipleCategories()
		throws Exception {
		...
		assertTrue(selenium.isChecked("//input[@id='_147_multiValuedCheckbox']"));
		selenium.clickAt("//input[@id='_147_multiValuedCheckbox']",
			RuntimeVariables.replace("Allow Multiple Categories"));
