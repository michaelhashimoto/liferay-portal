 ...
 */
public class DeleteCategoryProperty2Tests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddVocabularyTest.class);
		testSuite.addTestSuite(AddCategoryProperty1Test.class);
		testSuite.addTestSuite(AddCategoryProperty2Test.class);
		testSuite.addTestSuite(DeleteCategoryProperty2Test.class);
		testSuite.addTestSuite(ViewDeleteCategoryProperty2Test.class);
