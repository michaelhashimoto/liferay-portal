 ...
 */
public class AddDataDefinitionFileUploadTest extends BaseTestCase {
	public void testAddDataDefinitionFileUpload() throws Exception {
		...
		selenium.type("//input[@id='_166_name_en_US']",
			RuntimeVariables.replace("Data Definition File Upload"));
