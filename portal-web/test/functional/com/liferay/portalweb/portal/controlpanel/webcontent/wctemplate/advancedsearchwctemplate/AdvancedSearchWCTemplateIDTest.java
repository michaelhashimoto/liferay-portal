 ...
 */
public class AdvancedSearchWCTemplateIDTest extends BaseTestCase {
	public void testAdvancedSearchWCTemplateID() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				selenium.waitForVisible("//input[@id='_15_searchTemplateId']");
