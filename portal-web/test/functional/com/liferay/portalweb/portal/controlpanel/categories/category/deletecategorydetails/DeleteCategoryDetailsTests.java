 ...
 */
public class DeleteCategoryDetailsTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddVocabularyTest.class);
		testSuite.addTestSuite(AddCategoryTest.class);
		testSuite.addTestSuite(DeleteCategoryDetailsTest.class);
		testSuite.addTestSuite(ViewDeleteCategoryDetailsTest.class);
