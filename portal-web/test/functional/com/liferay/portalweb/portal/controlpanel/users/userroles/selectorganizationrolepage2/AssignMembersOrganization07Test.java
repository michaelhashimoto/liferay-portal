 ...
 */
public class AssignMembersOrganization07Test extends BaseTestCase {
	public void testAssignMembersOrganization07() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.type("//input[@name='_125_keywords']",
					RuntimeVariables.replace("\"Organization 07\""));
