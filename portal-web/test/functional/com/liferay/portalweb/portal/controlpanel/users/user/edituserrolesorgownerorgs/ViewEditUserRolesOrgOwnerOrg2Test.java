 ...
 */
public class ViewEditUserRolesOrgOwnerOrg2Test extends BaseTestCase {
	public void testViewEditUserRolesOrgOwnerOrg2() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				assertEquals(RuntimeVariables.replace("Remove"),
					selenium.getText(
						"//td[@id='_125_organizationRolesSearchContainer_col-3_row-2']"));
