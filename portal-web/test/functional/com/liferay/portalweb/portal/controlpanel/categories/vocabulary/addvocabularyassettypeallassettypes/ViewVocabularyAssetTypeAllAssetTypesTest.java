 ...
 */
public class ViewVocabularyAssetTypeAllAssetTypesTest extends BaseTestCase {
	public void testViewVocabularyAssetTypeAllAssetTypes()
		throws Exception {
		int label = 1;
