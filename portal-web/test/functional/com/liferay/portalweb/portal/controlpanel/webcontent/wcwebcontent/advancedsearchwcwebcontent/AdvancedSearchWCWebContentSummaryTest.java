 ...
 */
public class AdvancedSearchWCWebContentSummaryTest extends BaseTestCase {
	public void testAdvancedSearchWCWebContentSummary()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				selenium.type("//input[@id='_15_description']",
					RuntimeVariables.replace("Summary1"));
				selenium.clickAt("//div[2]/span[2]/span/input",
					RuntimeVariables.replace("Search"));
				selenium.waitForPageToLoad("30000");
				selenium.type("//input[@id='_15_description']",
