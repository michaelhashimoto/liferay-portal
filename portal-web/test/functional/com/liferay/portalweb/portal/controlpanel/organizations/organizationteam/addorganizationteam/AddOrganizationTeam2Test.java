 ...
 */
public class AddOrganizationTeam2Test extends BaseTestCase {
	public void testAddOrganizationTeam2() throws Exception {
		...
		selenium.type("//input[@id='_174_name']",
			RuntimeVariables.replace("Organization Team2 Name"));
		selenium.type("//textarea[@id='_174_description']",
			RuntimeVariables.replace("Organization Team2 Description"));
