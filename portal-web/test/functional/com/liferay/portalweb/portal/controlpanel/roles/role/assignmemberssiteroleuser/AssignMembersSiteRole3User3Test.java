 ...
 */
public class AssignMembersSiteRole3User3Test extends BaseTestCase {
	public void testAssignMembersSiteRole3User3() throws Exception {
		...
		selenium.type("//input[@id='_174_keywords']",
			RuntimeVariables.replace("Siterole3"));
		selenium.clickAt("//input[@value='Search']",
			RuntimeVariables.replace("Search"));
		selenium.waitForPageToLoad("30000");
		...
		assertEquals(RuntimeVariables.replace("Site"),
			selenium.getText("//tr[contains(.,'Roles Siterole3 Name')]/td[2]/a"));
