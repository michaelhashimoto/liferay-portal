 ...
 */
public class ViewVocabulary1Test extends BaseTestCase {
	public void testViewVocabulary1() throws Exception {
		...
		assertEquals("Vocabulary1 Name",
			selenium.getValue("//input[@id='_147_title_en_US']"));
		assertEquals(RuntimeVariables.replace("Vocabulary1 Description"),
