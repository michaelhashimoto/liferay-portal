 ...
 */
public class EditUser2OrgRole2Test extends BaseTestCase {
	public void testEditUser2OrgRole2() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Organization Name"),
			selenium.getText(
				"//td[@id='_125_usersSearchContainer_col-organizations_row-usersn2']/a"));
		...
		assertEquals(RuntimeVariables.replace("Roles Orgrole2 Name"),
			selenium.getText(
				"//tr[contains(.,'Roles Orgrole2 Name')]/td[@headers='_125_rolesSearchContainer_col-title']/a"));
		selenium.clickAt("//tr[contains(.,'Roles Orgrole2 Name')]/td[@headers='_125_rolesSearchContainer_col-title']/a",
