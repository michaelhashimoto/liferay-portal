 ...
 */
public class AddVocabularyAssetTypeCalendarEventTest extends BaseTestCase {
	public void testAddVocabularyAssetTypeCalendarEvent()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				selenium.select("//select[@id='_147_classNameId0']",
					RuntimeVariables.replace("Calendar Event"));
