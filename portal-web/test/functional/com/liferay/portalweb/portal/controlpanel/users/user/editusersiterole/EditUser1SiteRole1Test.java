 ...
 */
public class EditUser1SiteRole1Test extends BaseTestCase {
	public void testEditUser1SiteRole1() throws Exception {
		...
		selenium.waitForVisible(
			"//tr[contains(.,'Roles Siterole1 Name')]/td[@headers='_125_rolesSearchContainer_col-title']/a");
		assertEquals(RuntimeVariables.replace("Roles Siterole1 Name"),
			selenium.getText(
				"//tr[contains(.,'Roles Siterole1 Name')]/td[@headers='_125_rolesSearchContainer_col-title']/a"));
		selenium.clickAt("//tr[contains(.,'Roles Siterole1 Name')]/td[@headers='_125_rolesSearchContainer_col-title']/a",
