...
public class AssignMembersRegRole1User1Test extends BaseTestCase {
	public void testAssignMembersRegRole1User1() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Regular"),
			selenium.getText("//tr[contains(.,'Roles Regrole1 Name')]/td[2]/a"));
		assertEquals(RuntimeVariables.replace(""),
			selenium.getText("//tr[contains(.,'Roles Regrole1 Name')]/td[3]/a"));
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'Roles Regrole1 Name')]/td[4]/span[@title='Actions']/ul/li/strong/a/span"));
		selenium.clickAt("//tr[contains(.,'Roles Regrole1 Name')]/td[4]/span[@title='Actions']/ul/li/strong/a/span",
