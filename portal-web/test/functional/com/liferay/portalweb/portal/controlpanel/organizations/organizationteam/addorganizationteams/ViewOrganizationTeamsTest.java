 ...
 */
public class ViewOrganizationTeamsTest extends BaseTestCase {
	public void testViewOrganizationTeams() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'Organization Team1 Name')]/td[3]/span[@title='Actions']/ul/li/strong/a/span"));
		assertEquals(RuntimeVariables.replace("Organization Team2 Name"),
			selenium.getText(
				"//tr[contains(.,'Organization Team2 Name')]/td[1]/a"));
		assertEquals(RuntimeVariables.replace("Organization Team2 Description"),
			selenium.getText(
				"//tr[contains(.,'Organization Team2 Name')]/td[2]/a"));
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'Organization Team2 Name')]/td[3]/span[@title='Actions']/ul/li/strong/a/span"));
		...
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'Organization Team3 Name')]/td[3]/span[@title='Actions']/ul/li/strong/a/span"));
