...
public class AddOrganizationPhoneNumber3Test extends BaseTestCase {
	public void testAddOrganizationPhoneNumber3() throws Exception {
		...
		selenium.waitForVisible("//input[@id='_125_phoneNumber3']");
		selenium.type("//input[@id='_125_phoneNumber3']",
			RuntimeVariables.replace("5628020525"));
		...
		selenium.clickAt("//input[@id='_125_phonePrimary3']",
