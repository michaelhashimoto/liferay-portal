 ...
 */
public class ConfigurePortletAddCounter4BlogEntryUpdatesTest
	extends BaseTestCase {
	public void testConfigurePortletAddCounter4BlogEntryUpdates()
		throws Exception {
		...
		selenium.select("//select[@id='_86_displayActivityCounterName4']",
			RuntimeVariables.replace("User's Blog Entry Updates"));
		...
		assertEquals("User's Blog Entry Updates",
