...
public class ReindexAllSearchIndexesTest extends BaseTestCase {
	public void testReindexAllSearchIndexes() throws Exception {
		...
		assertEquals("Execute",
			selenium.getValue("//tr[4]/td[2]/input[@value='Execute']"));
		selenium.clickAt("//tr[4]/td[2]/input[@value='Execute']",
		...
		assertEquals("Execute",
			selenium.getValue("//tr[5]/td[2]/input[@value='Execute']"));
		selenium.clickAt("//tr[5]/td[2]/input[@value='Execute']",
			RuntimeVariables.replace("Execute"));
		selenium.waitForPageToLoad("30000");
		assertEquals(RuntimeVariables.replace(
				"Your request completed successfully."),
