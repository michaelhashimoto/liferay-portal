 ...
 */
public class AddPage2BlogsEntry7Test extends BaseTestCase {
	public void testAddPage2BlogsEntry7() throws Exception {
		...
		selenium.type("//input[@id='_33_title']",
			RuntimeVariables.replace("Blogs Entry7 Title"));
		...
		selenium.type("//td[@id='cke_contents__33_editor']/textarea",
			RuntimeVariables.replace("Blogs Entry7 Content"));
		assertEquals(RuntimeVariables.replace("Source"),
			selenium.getText("//span[.='Source']"));
		selenium.clickAt("//span[.='Source']",
			RuntimeVariables.replace("Source"));
		...
		selenium.waitForText("//body", "Blogs Entry7 Content");
		selenium.selectFrame("relative=top");
		...
		assertEquals(RuntimeVariables.replace("Blogs"),
			selenium.getText("//span[@class='portlet-title-text']"));
		assertFalse(selenium.isTextPresent("Blogs Entry7 Title"));
