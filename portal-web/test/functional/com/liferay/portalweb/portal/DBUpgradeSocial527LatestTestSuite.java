...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.social.Social527LatestTestPlan;
 ...
 */
public class DBUpgradeSocial527LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new NamedTestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Social527LatestTestPlan.suite());
