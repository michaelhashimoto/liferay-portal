...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.polls.Polls528LatestTestPlan;
 ...
 */
public class DBUpgradePolls528LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new NamedTestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Polls528LatestTestPlan.suite());
