...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.social.Social525LatestTestPlan;
 ...
 */
public class DBUpgradeSocial525LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new NamedTestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Social525LatestTestPlan.suite());
