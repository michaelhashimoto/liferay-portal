...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.phone.Phone525LatestTestPlan;
 ...
 */
public class DBUpgradePhone525LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new NamedTestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Phone525LatestTestPlan.suite());
