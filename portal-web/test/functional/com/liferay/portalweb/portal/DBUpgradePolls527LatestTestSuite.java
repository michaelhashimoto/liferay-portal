...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.polls.Polls527LatestTestPlan;
 ...
 */
public class DBUpgradePolls527LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new NamedTestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Polls527LatestTestPlan.suite());
