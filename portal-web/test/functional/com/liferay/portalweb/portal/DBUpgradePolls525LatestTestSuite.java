...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.polls.Polls525LatestTestPlan;
 ...
 */
public class DBUpgradePolls525LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new NamedTestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Polls525LatestTestPlan.suite());
