 ...
 */
public class WaitForNotValue1Test extends BaseTestCase {
	public void testWaitForNotValue1() throws Exception {
		...
		selenium.waitForNotValue("//input[@value='Save']", "Catherine");
	}
}