 ...
 */
public class SelectPopUp2Test extends BaseTestCase {
	public void testSelectPopUp2() throws Exception {
		...
		Thread.sleep(5000);
		assertTrue(selenium.isElementNotPresent("css=img[alt=\"Liferay\"]"));
	}
}