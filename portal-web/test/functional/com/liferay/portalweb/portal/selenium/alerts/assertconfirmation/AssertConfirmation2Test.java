 ...
 */
public class AssertConfirmation2Test extends BaseTestCase {
	public void testAssertConfirmation2() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				selenium.waitForPageToLoad("30000");
				assertTrue(selenium.getConfirmation().matches("^Catherine$"));
