...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.tags.Tags529LatestTestPlan;
 ...
 */
public class DBUpgradeTags529LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new NamedTestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Tags529LatestTestPlan.suite());
