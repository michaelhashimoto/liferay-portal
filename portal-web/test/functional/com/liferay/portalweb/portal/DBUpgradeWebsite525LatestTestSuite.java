...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.website.Website525LatestTestPlan;
 ...
 */
public class DBUpgradeWebsite525LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new NamedTestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Website525LatestTestPlan.suite());
