...
import com.liferay.portalweb.socialofficeprofile.profile.sousaddprofilepictureprofile.SOUs_AddProfilePictureProfileTest;
 ...
 */
public class SOUs_EditProfilePictureProfileTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SOUs_AddProfilePictureProfileTest.class);
		testSuite.addTestSuite(SOUs_EditProfilePictureProfileTest.class);
