 ...
 */
public class SOUs_EditSMSNullProfileTest extends BaseTestCase {
	public void testSOUs_EditSMSNullProfile() throws Exception {
		...
		assertFalse(selenium.isTextPresent("SMS:"));
	}
}