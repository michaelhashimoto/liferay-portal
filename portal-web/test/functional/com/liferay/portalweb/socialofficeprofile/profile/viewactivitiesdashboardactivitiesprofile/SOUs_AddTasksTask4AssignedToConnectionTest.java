 ...
 */
public class SOUs_AddTasksTask4AssignedToConnectionTest extends BaseTestCase {
	public void testSOUs_AddTasksTask4AssignedToConnection()
		throws Exception {
		...
		selenium.type("//input[@id='_1_WAR_tasksportlet_title']",
			RuntimeVariables.replace("Task4 Description"));
		...
		selenium.waitForText("//h1[@class='header-title']", "Task4 Description");
		assertEquals(RuntimeVariables.replace("Task4 Description"),
