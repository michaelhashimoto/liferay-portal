...
package com.liferay.portalweb.socialofficeprofile.profile.sousaddprofilepictureprofile;
 ...
 */
public class SOUs_AddProfilePictureProfileTest extends BaseTestCase {
	public void testSOUs_AddProfilePictureProfile() throws Exception {
		...
		selenium.selectWindow("null");
		Thread.sleep(1000);
		selenium.waitForElementNotPresent("//img[contains(@src,'default')]");
