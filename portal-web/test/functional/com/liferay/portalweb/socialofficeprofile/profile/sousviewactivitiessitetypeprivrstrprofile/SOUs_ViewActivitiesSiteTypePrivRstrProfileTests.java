 ...
 */
public class SOUs_ViewActivitiesSiteTypePrivRstrProfileTests
	...
	public static Test suite() {
		...
		testSuite.addTestSuite(AddCalendarEventSiteTypePrivateRestrictedTest.class);
		testSuite.addTestSuite(AddDMDocumentSiteTypePrivateRestrictedTest.class);
		testSuite.addTestSuite(PostNewMBThreadSiteTypePrivateRestrictedTest.class);
		testSuite.addTestSuite(AddBlogsEntrySiteTypePrivateRestrictedTest.class);
		testSuite.addTestSuite(AddWikiFrontPageSiteTypePrivateRestrictedTest.class);
		...
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewActivitiesSiteTypePrivRstrProfileTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
