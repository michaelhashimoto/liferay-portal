 ...
 */
public class AddUserSOProfilePictureTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AddUserSOProfilePictureTest.class);
		testSuite.addTestSuite(ViewProfileProfilePictureTest.class);
