 ...
 */
public class SOUs_ViewActivitiesSiteTypePrivRstrProfileTest extends BaseTestCase {
	public void testSOUs_ViewActivitiesSiteTypePrivRstrProfile()
		throws Exception {
		...
		assertFalse(selenium.isTextPresent(
				"Joe updated a wiki page, FrontPage, in Private Restricted Site Name."));
		assertFalse(selenium.isTextPresent(
				"Joe wrote a new blog entry, Blogs Entry Title, in Private Restricted Site Name."));
		assertFalse(selenium.isTextPresent(
				"Joe wrote a new message board post, MB Thread Message Subject, in Private Restricted Site Name."));
		assertFalse(selenium.isTextPresent(
				"Joe uploaded a new document, DM Document Title, in Private Restricted Site Name."));
		assertFalse(selenium.isTextPresent(
				"Joe added a new calendar event, Calendar Event Title, in Private Restricted Site Name."));
