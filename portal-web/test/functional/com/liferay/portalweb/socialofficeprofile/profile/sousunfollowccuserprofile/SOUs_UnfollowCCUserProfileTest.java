 ...
 */
public class SOUs_UnfollowCCUserProfileTest extends BaseTestCase {
	public void testSOUs_UnfollowCCUserProfile() throws Exception {
		...
		selenium.clickAt("//span[@class='action unfollow']/a",
			RuntimeVariables.replace("Unfollow"));
		selenium.waitForElementPresent("//span[@class='action follow']/a");
