 ...
 */
public class PostNewMBCategoryThreadQuestionMessageSiteTest extends BaseTestCase {
	public void testPostNewMBCategoryThreadQuestionMessageSite()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				assertTrue(selenium.isPartialText(
						"//label[@for='_19_questionCheckbox']",
						"Mark as a Question"));

				boolean markAsQuestionChecked = selenium.isChecked(
						"//input[@id='_19_questionCheckbox']");

				if (markAsQuestionChecked) {
					label = 2;
