 ...
 */
public class EditMBCategoryThreadMessageSiteTest extends BaseTestCase {
	public void testEditMBCategoryThreadMessageSite() throws Exception {
		...
		selenium.waitForText("//body", "MB Category Thread Message Body Edit");
		selenium.selectFrame("relative=top");
