 ...
 */
public class DeleteMBCategoryThreadMessageSiteTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(DeleteMBCategoryThreadMessageSiteTest.class);
		testSuite.addTestSuite(ViewDeleteMBCategoryThreadMessageSiteTest.class);
