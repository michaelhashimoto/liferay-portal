 ...
 */
public class ImportMBSiteLARTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ImportMBSiteTemplateLARTest.class);
		testSuite.addTestSuite(AddSitesSiteTest.class);
		testSuite.addTestSuite(ImportMBSiteLARTest.class);
		testSuite.addTestSuite(ViewImportMBSiteLARTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewImportMBSiteLARTest.class);
