 ...
 */
public class ReplyMBCategoryThreadMessageReply2SiteTest extends BaseTestCase {
	public void testReplyMBCategoryThreadMessageReply2Site()
		throws Exception {
		...
		selenium.waitForText("//body", "MB Category Thread Message Reply2 Body");
		selenium.selectFrame("relative=top");
