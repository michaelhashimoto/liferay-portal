 ...
 */
public class ImportWikiSiteTemplateLARTest extends BaseTestCase {
	public void testImportWikiSiteTemplateLAR() throws Exception {
		...
		selenium.uploadFile("//input[@id='_149_importFileName']",
			RuntimeVariables.replace(
				"L:\\portal\\build\\portal-web\\test\\functional\\com\\liferay\\portalweb\\socialofficesite\\wiki\\dependencies\\SO_Site_Template_Wiki-Selenium.lar"));
