 ...
 */
public class SaveAndCheckinMajorDMFolderDocumentSiteTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SaveAndCheckinMajorDMFolderDocumentSiteTest.class);
		testSuite.addTestSuite(ViewSaveAndCheckinMajorDMFolderDocumentSiteTest.class);
