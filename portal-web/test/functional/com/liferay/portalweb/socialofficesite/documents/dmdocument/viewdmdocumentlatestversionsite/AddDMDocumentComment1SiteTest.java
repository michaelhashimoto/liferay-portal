 ...
 */
public class AddDMDocumentComment1SiteTest extends BaseTestCase {
	public void testAddDMDocumentComment1Site() throws Exception {
		...
		selenium.type("//textarea[@name='_20_postReplyBody0']",
			RuntimeVariables.replace("DM Document Comment1"));
