 ...
 */
public class AddDMFolderDocument3SiteTest extends BaseTestCase {
	public void testAddDMFolderDocument3Site() throws Exception {
		...
		selenium.uploadCommonFile("//input[@id='_20_file']",
			RuntimeVariables.replace("Document_3.doc"));
