...
package com.liferay.portalweb.socialofficesite.documents.dmdocument.adddmfolderdocumenttagssite;
 ...
 */
public class AddDMFolderDocumentTagsSiteTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddSitesSiteTest.class);
		testSuite.addTestSuite(AddDMFolderSiteTest.class);
		testSuite.addTestSuite(AddDMFolderDocumentTagsSiteTest.class);
		testSuite.addTestSuite(ViewDMFolderDocumentTagsSiteTest.class);
