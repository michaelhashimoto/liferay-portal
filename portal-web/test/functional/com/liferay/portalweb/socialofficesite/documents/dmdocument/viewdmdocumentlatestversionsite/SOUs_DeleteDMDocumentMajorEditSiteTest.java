 ...
 */
public class SOUs_DeleteDMDocumentMajorEditSiteTest extends BaseTestCase {
	public void testSOUs_DeleteDMDocumentMajorEditSite()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Delete Version"),
			selenium.getText("xPath=(//div[@class='actions']/span[4]/a)[1]"));
		selenium.clickAt("xPath=(//div[@class='actions']/span[4]/a)[1]",
		...
		assertEquals(RuntimeVariables.replace("Add Comment"),
			selenium.getText(
				"xPath=(//fieldset[@class='aui-fieldset add-comment ']/div/span[1])[3]"));
		assertEquals(RuntimeVariables.replace("Subscribe to Comments"),
			selenium.getText(
				"xPath=(//fieldset[@class='aui-fieldset add-comment ']/div/span[2])[2]"));
