 ...
 */
public class SelectDocumentEditorRoleSOUserTest extends BaseTestCase {
	public void testSelectDocumentEditorRoleSOUser() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				assertEquals(RuntimeVariables.replace("Document Editor Name"),
					selenium.getText("link=Document Editor Name"));
				selenium.click("link=Document Editor Name");
				selenium.selectWindow("null");
				selenium.waitForText("//tr[contains(., 'Document Editor Name')]/td",
					"Document Editor Name");
				assertEquals(RuntimeVariables.replace("Document Editor Name"),
					selenium.getText(
						"//tr[contains(., 'Document Editor Name')]/td"));
