 ...
 */
public class CancelCheckoutDMFolderDocumentSiteTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(CancelCheckoutDMFolderDocumentSiteTest.class);
		testSuite.addTestSuite(ViewCancelCheckoutDMFolderDocumentSiteTest.class);
