 ...
 */
public class SaveAndCheckinMinorDMFolderDocumentSiteTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SaveAndCheckinMinorDMFolderDocumentSiteTest.class);
		testSuite.addTestSuite(ViewSaveAndCheckinMinorDMFolderDocumentSiteTest.class);
