 ...
 */
public class AddDMFolderDocumentCommentSiteTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AddDMFolderDocumentCommentSiteTest.class);
		testSuite.addTestSuite(ViewDMFolderDocumentCommentSiteTest.class);
