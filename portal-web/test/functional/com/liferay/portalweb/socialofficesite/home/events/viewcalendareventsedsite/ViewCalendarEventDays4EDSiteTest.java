 ...
 */
public class ViewCalendarEventDays4EDSiteTest extends BaseTestCase {
	public void testViewCalendarEventDays4EDSite() throws Exception {
		...
		assertTrue(selenium.isElementNotPresent(
				"xPath=(//span[@class='event-name']/a)[5]"));
		selenium.clickAt("xPath=(//span[@class='event-name']/a)[4]",
		...
		assertEquals(RuntimeVariables.replace(
				"Calendar Future Day3 Event Description"),
			selenium.getText(
				"//p[contains(.,'Calendar Future Day3 Event Description')]"));
