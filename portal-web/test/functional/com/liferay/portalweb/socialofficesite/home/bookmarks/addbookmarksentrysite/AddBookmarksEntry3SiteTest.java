 ...
 */
public class AddBookmarksEntry3SiteTest extends BaseTestCase {
	public void testAddBookmarksEntry3Site() throws Exception {
		...
		selenium.type("//input[@id='_28_url']",
			RuntimeVariables.replace("http://www.msn.com"));
		selenium.type("//textarea[@id='_28_description']",
			RuntimeVariables.replace("Bookmarks Entry3 Description"));
