 ...
 */
public class ImportBookmarksSiteLARTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ImportBookmarksSiteTemplateLARTest.class);
		testSuite.addTestSuite(AddSitesSiteTest.class);
		testSuite.addTestSuite(ImportBookmarksSiteLARTest.class);
		testSuite.addTestSuite(ViewImportBookmarksSiteLARTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewImportBookmarksSiteLARTest.class);
