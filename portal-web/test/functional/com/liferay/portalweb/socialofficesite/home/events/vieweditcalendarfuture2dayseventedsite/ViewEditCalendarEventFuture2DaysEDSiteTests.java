 ...
 */
public class ViewEditCalendarEventFuture2DaysEDSiteTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(EditCalendarEventFuture2DaysSiteTest.class);
		testSuite.addTestSuite(ConfigureDisplayDays4EDSiteTest.class);
		testSuite.addTestSuite(ViewEditCalendarEventFuture2DaysEDSiteTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewEditCalendarEventFuture2DaysEDSiteTest.class);
