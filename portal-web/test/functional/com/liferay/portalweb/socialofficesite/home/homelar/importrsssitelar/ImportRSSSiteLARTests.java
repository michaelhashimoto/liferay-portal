 ...
 */
public class ImportRSSSiteLARTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ImportRSSSiteTemplateLARTest.class);
		testSuite.addTestSuite(AddSitesSiteTest.class);
		testSuite.addTestSuite(ImportRSSSiteLARTest.class);
		testSuite.addTestSuite(ViewImportRSSSiteLARTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewImportRSSSiteLARTest.class);
