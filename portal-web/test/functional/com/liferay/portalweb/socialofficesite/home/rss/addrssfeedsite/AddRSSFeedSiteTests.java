 ...
 */
public class AddRSSFeedSiteTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AddRSSFeedSiteTest.class);
		testSuite.addTestSuite(ViewRSSFeedSiteTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewRSSFeedSiteTest.class);
