 ...
 */
public class SOUs_ViewImportRSSSiteLARTest extends BaseTestCase {
	public void testSOUs_ViewImportRSSSiteLAR() throws Exception {
		...
		assertTrue(selenium.isPartialText(
				"//div[contains(.,'NYT')]/div[@class='feed-title']", "NYT"));
		assertTrue(selenium.isPartialText(
