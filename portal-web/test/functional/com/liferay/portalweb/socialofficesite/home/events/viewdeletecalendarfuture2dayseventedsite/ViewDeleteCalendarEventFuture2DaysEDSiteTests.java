 ...
 */
public class ViewDeleteCalendarEventFuture2DaysEDSiteTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(DeleteCalendarEventFuture2DaysSiteTest.class);
		testSuite.addTestSuite(ConfigureDisplayDays4EDSiteTest.class);
		testSuite.addTestSuite(ViewDeleteCalendarEventFuture2DaysEDSiteTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewDeleteCalendarEventFuture2DaysEDSiteTest.class);
