 ...
 */
public class ViewCalendarEvent2DaysGuestNoViewEDSiteTest extends BaseTestCase {
	public void testViewCalendarEvent2DaysGuestNoViewEDSite()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
				"Calendar Future Day2 Event Description"),
			selenium.getText(
				"//p[contains(.,'Calendar Future Day2 Event Description')]"));
