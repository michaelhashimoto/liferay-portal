 ...
 */
public class AddBookmarksEntry1SiteTest extends BaseTestCase {
	public void testAddBookmarksEntry1Site() throws Exception {
		...
		selenium.type("//textarea[@id='_28_description']",
			RuntimeVariables.replace("Bookmarks Entry1 Description"));
