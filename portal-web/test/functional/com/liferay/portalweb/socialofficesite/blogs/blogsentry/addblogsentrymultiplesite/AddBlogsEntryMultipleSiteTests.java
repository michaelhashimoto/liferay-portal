 ...
 */
public class AddBlogsEntryMultipleSiteTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddSitesSiteTest.class);
		testSuite.addTestSuite(AddBlogsEntry1SiteTest.class);
		testSuite.addTestSuite(ViewBlogsEntry1SiteTest.class);
		testSuite.addTestSuite(AddBlogsEntry2SiteTest.class);
		testSuite.addTestSuite(ViewBlogsEntry2SiteTest.class);
		testSuite.addTestSuite(AddBlogsEntry3SiteTest.class);
		testSuite.addTestSuite(ViewBlogsEntry3SiteTest.class);
