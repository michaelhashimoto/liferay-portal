 ...
 */
public class AddCalendarEventFuture3DaysSiteTest extends BaseTestCase {
	public void testAddCalendarEventFuture3DaysSite() throws Exception {
		...
		selenium.type("//input[@id='_8_title']",
			RuntimeVariables.replace("Calendar Future Day3 Event Title"));
		...
		selenium.type("//td[@id='cke_contents__8_editor']/textarea",
			RuntimeVariables.replace("Calendar Future Day3 Event Description"));
		assertEquals(RuntimeVariables.replace("Source"),
			selenium.getText("//span[.='Source']"));
		selenium.clickAt("//span[.='Source']",
			RuntimeVariables.replace("Source"));
		...
		selenium.waitForText("//body", "Calendar Future Day3 Event Description");
		selenium.selectFrame("relative=top");
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText(
				"xPath=(//td[contains(@id,'_8_ocerSearchContainer_col-title')])[contains(.,'Calendar Future Day3 Event Title')]"));
	}
}