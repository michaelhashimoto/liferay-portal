 ...
 */
public class EditPermissionsCalendarEvent2GuestNoViewTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(EditPermissionsCalendarEvent2GuestNoViewTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewCalendarEventSiteTest.class);
