 ...
 */
public class ViewEditCalendarEventSiteTest extends BaseTestCase {
	public void testViewEditCalendarEventSite() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Calendar Event Description Edit"),
