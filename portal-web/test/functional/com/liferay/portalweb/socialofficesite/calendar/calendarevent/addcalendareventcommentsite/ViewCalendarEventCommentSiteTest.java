 ...
 */
public class ViewCalendarEventCommentSiteTest extends BaseTestCase {
	public void testViewCalendarEventCommentSite() throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
				"Add Comment Unsubscribe from Comments"),
			selenium.getText(
