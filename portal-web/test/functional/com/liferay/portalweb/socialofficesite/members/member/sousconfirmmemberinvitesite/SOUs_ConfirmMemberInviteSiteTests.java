 ...
 */
public class SOUs_ConfirmMemberInviteSiteTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SOUs_ViewConfirmMemberInviteSiteTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
		testSuite.addTestSuite(ViewConfirmMemberInviteSOUserSiteTest.class);
