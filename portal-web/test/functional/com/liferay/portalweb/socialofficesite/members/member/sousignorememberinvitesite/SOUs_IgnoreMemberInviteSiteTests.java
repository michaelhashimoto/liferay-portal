 ...
 */
public class SOUs_IgnoreMemberInviteSiteTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SOUs_IgnoreMemberInviteSiteTest.class);
		testSuite.addTestSuite(SOUs_ViewIgnoreMemberInviteSiteTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
		testSuite.addTestSuite(ViewIgnoreMemberInviteSOUserSiteTest.class);
