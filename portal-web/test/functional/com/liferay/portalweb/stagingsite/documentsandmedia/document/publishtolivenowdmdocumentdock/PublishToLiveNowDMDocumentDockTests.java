 ...
 */
public class PublishToLiveNowDMDocumentDockTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(PublishToLiveNowDMDocumentDockTest.class);
		testSuite.addTestSuite(ViewPublishToLiveNowDMDocumentDockTest.class);
