 ...
 */
public class PublishToLiveNowDMDocumentNoDataDockTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(PublishToLiveNowDMDocumentNoDataDockTest.class);
		testSuite.addTestSuite(ViewPublishToLiveNowDMDocumentNoDataDockTest.class);
