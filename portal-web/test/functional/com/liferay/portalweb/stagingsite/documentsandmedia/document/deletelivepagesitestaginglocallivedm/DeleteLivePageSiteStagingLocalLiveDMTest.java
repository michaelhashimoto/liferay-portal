 ...
 */
public class DeleteLivePageSiteStagingLocalLiveDMTest extends BaseTestCase {
	public void testDeleteLivePageSiteStagingLocalLiveDM()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.waitForVisible("//a[@class='document-link']");
				assertEquals(RuntimeVariables.replace("DM Document Title"),
					selenium.getText("//a[@class='document-link']"));
			...
			case 2:
				...
				selenium.waitForText("//a/span", "Change");
				...
				selenium.waitForVisible("//span[1]/span/span/input");
