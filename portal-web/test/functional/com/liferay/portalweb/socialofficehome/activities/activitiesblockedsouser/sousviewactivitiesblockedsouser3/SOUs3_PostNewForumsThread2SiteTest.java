 ...
 */
public class SOUs3_PostNewForumsThread2SiteTest extends BaseTestCase {
	public void testSOUs3_PostNewForumsThread2Site() throws Exception {
		...
		selenium.type("//input[@id='_19_subject']",
			RuntimeVariables.replace("Forums Thread2 Message Subject"));
		...
		selenium.type("//td[@id='cke_contents__19_editor']/textarea",
			RuntimeVariables.replace("Forums Thread2 Message Body"));
		assertEquals(RuntimeVariables.replace("Source"),
			selenium.getText("//span[.='Source']"));
		selenium.clickAt("//span[.='Source']",
			RuntimeVariables.replace("Source"));
		...
		selenium.waitForText("//body", "Forums Thread2 Message Body");
		selenium.selectFrame("relative=top");
		...
		assertEquals(RuntimeVariables.replace("Forums Thread2 Message Subject"),
			selenium.getText("//div[@class='subject']/a/strong"));
		assertEquals(RuntimeVariables.replace("Forums Thread2 Message Body"),
