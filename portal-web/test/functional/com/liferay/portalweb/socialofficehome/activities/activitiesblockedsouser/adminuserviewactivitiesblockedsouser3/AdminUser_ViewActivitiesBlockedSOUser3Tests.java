...
import com.liferay.portalweb.socialofficehome.activities.activitiesblockedsouser.sousviewactivitiesblockedsouser3.AddMembersSiteTest;
import com.liferay.portalweb.socialofficehome.activities.activitiesblockedsouser.sousviewactivitiesblockedsouser3.SOUs1_AddAsConnectionCCSOUser3Test;
import com.liferay.portalweb.socialofficehome.activities.activitiesblockedsouser.sousviewactivitiesblockedsouser3.SOUs1_BlockCCSOUser3Test;
import com.liferay.portalweb.socialofficehome.activities.activitiesblockedsouser.sousviewactivitiesblockedsouser3.SOUs1_ViewActivitiesBlockedSOUser3Test;
import com.liferay.portalweb.socialofficehome.activities.activitiesblockedsouser.sousviewactivitiesblockedsouser3.SOUs1_ViewActivitiesSOUser3Test;
import com.liferay.portalweb.socialofficehome.activities.activitiesblockedsouser.sousviewactivitiesblockedsouser3.SOUs2_BlockCCSOUser3Test;
import com.liferay.portalweb.socialofficehome.activities.activitiesblockedsouser.sousviewactivitiesblockedsouser3.SOUs2_FollowCCSOUser3Test;
import com.liferay.portalweb.socialofficehome.activities.activitiesblockedsouser.sousviewactivitiesblockedsouser3.SOUs2_ViewActivitiesBlockedSOUser3Test;
import com.liferay.portalweb.socialofficehome.activities.activitiesblockedsouser.sousviewactivitiesblockedsouser3.SOUs2_ViewActivitiesSOUser3Test;
import com.liferay.portalweb.socialofficehome.activities.activitiesblockedsouser.sousviewactivitiesblockedsouser3.SOUs3_AddMicroblogsContent1ViewableByEveryoneTest;
import com.liferay.portalweb.socialofficehome.activities.activitiesblockedsouser.sousviewactivitiesblockedsouser3.SOUs3_AddMicroblogsContent2ViewableByEveryoneTest;
import com.liferay.portalweb.socialofficehome.activities.activitiesblockedsouser.sousviewactivitiesblockedsouser3.SOUs3_ConfirmNotificationsAddConnectionTest;
import com.liferay.portalweb.socialofficehome.activities.activitiesblockedsouser.sousviewactivitiesblockedsouser3.SOUs3_PostNewForumsThread1SiteTest;
import com.liferay.portalweb.socialofficehome.activities.activitiesblockedsouser.sousviewactivitiesblockedsouser3.SOUs3_PostNewForumsThread2SiteTest;
 ...
 */
public class AdminUser_ViewActivitiesBlockedSOUser3Tests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddSOUser1Test.class);
		testSuite.addTestSuite(SelectRegularRolesSOUser1Test.class);
		testSuite.addTestSuite(SelectAdministratorSOUser1Test.class);
		...
		testSuite.addTestSuite(SelectAdministratorSOUser2Test.class);
