 ...
 */
public class SOUs_ViewCCUserProfileTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AddIntroductionProfileTest.class);
		testSuite.addTestSuite(AddProjectsProfileTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewCCUserProfileTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
		testSuite.addTestSuite(TearDownIntroductionTest.class);
		testSuite.addTestSuite(TearDownProjectsTest.class);
