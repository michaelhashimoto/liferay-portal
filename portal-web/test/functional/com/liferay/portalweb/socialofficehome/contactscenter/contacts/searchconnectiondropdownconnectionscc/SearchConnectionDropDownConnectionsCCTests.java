 ...
 */
public class SearchConnectionDropDownConnectionsCCTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SearchUserDropDownConnectionsCCTest.class);
		...
		testSuite.addTestSuite(SearchConnectionDropDownConnectionsCCTest.class);
