...
package com.liferay.portalweb.socialofficehome.mydocuments.dmdocument.ratedmfolderimage;
 ...
 */
public class RateDMFolderImageTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddDMFolderTest.class);
		testSuite.addTestSuite(AddDMFolderImageTest.class);
		testSuite.addTestSuite(RateDMFolderImageTest.class);
