 ...
 */
public class SaveAsDraftEditDMFolderDocumentTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddDMFolderTest.class);
		testSuite.addTestSuite(AddDMFolderDocumentTest.class);
		testSuite.addTestSuite(SaveAsDraftEditDMFolderDocumentTest.class);
		testSuite.addTestSuite(ViewSaveAsDraftEditDMFolderDocumentTest.class);
