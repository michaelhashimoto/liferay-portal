 ...
 */
public class AddDMFolderImageCommentTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddDMFolderTest.class);
		testSuite.addTestSuite(AddDMFolderImageTest.class);
		testSuite.addTestSuite(AddDMFolderImageCommentTest.class);
		testSuite.addTestSuite(ViewDMFolderImageCommentTest.class);
