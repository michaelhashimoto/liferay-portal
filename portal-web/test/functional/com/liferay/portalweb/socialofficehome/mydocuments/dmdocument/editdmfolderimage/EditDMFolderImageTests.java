...
package com.liferay.portalweb.socialofficehome.mydocuments.dmdocument.editdmfolderimage;
 ...
 */
public class EditDMFolderImageTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddDMFolderTest.class);
		testSuite.addTestSuite(AddDMFolderImageTest.class);
		testSuite.addTestSuite(EditDMFolderImageTest.class);
