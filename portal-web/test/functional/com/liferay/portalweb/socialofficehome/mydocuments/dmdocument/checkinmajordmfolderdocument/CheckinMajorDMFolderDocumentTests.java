 ...
 */
public class CheckinMajorDMFolderDocumentTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(CheckinMajorDMFolderDocumentTest.class);
		testSuite.addTestSuite(ViewCheckinMajorDMFolderDocumentTest.class);
