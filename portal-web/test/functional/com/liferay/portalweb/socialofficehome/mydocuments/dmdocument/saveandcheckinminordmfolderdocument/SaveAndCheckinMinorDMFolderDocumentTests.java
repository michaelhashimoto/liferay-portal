 ...
 */
public class SaveAndCheckinMinorDMFolderDocumentTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SaveAndCheckinMinorDMFolderDocumentTest.class);
		testSuite.addTestSuite(ViewSaveAndCheckinMinorDMFolderDocumentTest.class);
