 ...
 */
public class SaveAndCheckinMajorDMFolderDocumentTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SaveAndCheckinMajorDMFolderDocumentTest.class);
		testSuite.addTestSuite(ViewSaveAndCheckinMajorDMFolderDocumentTest.class);
