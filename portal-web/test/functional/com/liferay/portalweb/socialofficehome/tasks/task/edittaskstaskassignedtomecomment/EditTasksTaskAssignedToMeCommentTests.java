 ...
 */
public class EditTasksTaskAssignedToMeCommentTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(EditTasksTaskAssignedToMeCommentTest.class);
		testSuite.addTestSuite(ViewEditTasksTaskAssignedToMeCommentTest.class);
