 ...
 */
public class SOUs_ViewMicroblogsContentTagTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AddMicroblogsContentTagViewableByConnectionsTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewMicroblogsContentTagTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
