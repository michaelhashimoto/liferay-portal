 ...
 */
public class AddMicroblogsContent3Tag2ViewableByEveryoneTest
	extends BaseTestCase {
	public void testAddMicroblogsContent3Tag2ViewableByEveryone()
		throws Exception {
		...
		selenium.sendKeys("//textarea",
			RuntimeVariables.replace("#Microblogs2 Post3"));
