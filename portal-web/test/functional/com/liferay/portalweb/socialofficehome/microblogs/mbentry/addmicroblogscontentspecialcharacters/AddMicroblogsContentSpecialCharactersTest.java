 ...
 */
public class AddMicroblogsContentSpecialCharactersTest extends BaseTestCase {
	public void testAddMicroblogsContentSpecialCharacters()
		throws Exception {
		...
		selenium.waitForText("//span[@class='microblogs-countdown']", "64");
		assertEquals(RuntimeVariables.replace("64"),
