 ...
 */
public class SOUs_ReplyMBContentViewableByConnectionCommentTests
	...
	public static Test suite() {
		...
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ReplyMBContentViewableByConnectionCommentTest.class);
		testSuite.addTestSuite(SOUs_ViewMBContentViewableByConnectionCommentTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
		testSuite.addTestSuite(ViewMBContentViewableByConnectionCommentTest.class);
