 ...
 */
public class SOUs_ReplyMBContentViewableByFollowersCommentTests
	...
	public static Test suite() {
		...
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ReplyMBContentViewableByFollowersCommentTest.class);
		testSuite.addTestSuite(SOUs_ViewMBContentViewableByFollowersCommentTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
		testSuite.addTestSuite(ViewMBContentViewableByFollowersCommentTest.class);
