 ...
 */
public class AcceptMemberRequestSitePublicRestrictTest extends BaseTestCase {
	public void testAcceptMemberRequestSitePublicRestrict()
		throws Exception {
		...
		selenium.type("//textarea[@id='_174_replyComments']",
			RuntimeVariables.replace(
				"Public Restricted Site Name Membership Approved"));
