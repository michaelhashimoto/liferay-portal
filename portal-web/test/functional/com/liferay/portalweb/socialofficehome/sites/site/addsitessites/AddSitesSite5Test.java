 ...
 */
public class AddSitesSite5Test extends BaseTestCase {
	public void testAddSitesSite5() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Open Site5 Name"),
			selenium.getText(
				"//li[contains(@class, 'social-office-enabled')]/span[contains(.,'Open Site5 Name')]/a"));
	}
}