 ...
 */
public class DenyMemberRequestSiteTypePrivateRestrictTest extends BaseTestCase {
	public void testDenyMemberRequestSiteTypePrivateRestrict()
		throws Exception {
		...
		selenium.type("//textarea[@id='_174_replyComments']",
			RuntimeVariables.replace(
				"Private Restricted Site Name Membership Denied"));
