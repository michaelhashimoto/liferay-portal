 ...
 */
public class SearchDMFolderDocumentDeleteSiteTypePrivateTests
	...
	public static Test suite() {
		...
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_AddDMFolderSiteTypePrivateTest.class);
		testSuite.addTestSuite(SOUs_AddDMFolderDocumentSiteTypePrivateTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
		...
		testSuite.addTestSuite(SearchDMFolderDocumentDeleteSiteTypePrivateTest.class);
