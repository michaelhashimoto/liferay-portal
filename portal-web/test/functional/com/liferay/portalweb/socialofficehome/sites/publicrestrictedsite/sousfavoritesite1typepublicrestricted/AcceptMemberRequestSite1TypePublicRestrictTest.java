 ...
 */
public class AcceptMemberRequestSite1TypePublicRestrictTest extends BaseTestCase {
	public void testAcceptMemberRequestSite1TypePublicRestrict()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
				"Social01 Office01 User01 wishes to join Public Restricted Site1 Name."),
		...
		selenium.waitForPageToLoad("30000");
		assertEquals(RuntimeVariables.replace(
				"Reply Membership Request for Public Restricted Site1 Name"),
		...
		selenium.type("//textarea[@id='_174_replyComments']",
			RuntimeVariables.replace(
				"Public Restricted Site1 Name Membership Approved"));
