 ...
 */
public class AddSitesSite1TypePublicRestrictedTest extends BaseTestCase {
	public void testAddSitesSite1TypePublicRestricted()
		throws Exception {
		...
		selenium.type("//textarea[@id='_5_WAR_soportlet_description']",
			RuntimeVariables.replace("Public Restricted Site1 Description"));
