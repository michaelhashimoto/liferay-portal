 ...
 */
public class SOUs_LeaveSiteTypePrivateRestrictedTest extends BaseTestCase {
	public void testSOUs_LeaveSiteTypePrivateRestricted()
		throws Exception {
		...
		assertTrue(selenium.getConfirmation()
						   .matches("^Are you sure you want to leave Private Restricted Site Name[\\s\\S]$"));
