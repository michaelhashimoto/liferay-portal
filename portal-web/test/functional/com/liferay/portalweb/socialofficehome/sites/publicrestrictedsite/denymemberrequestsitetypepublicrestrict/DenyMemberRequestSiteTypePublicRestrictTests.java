 ...
 */
public class DenyMemberRequestSiteTypePublicRestrictTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(DenyMemberRequestSiteTypePublicRestrictTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewDenyMemberSitePublicRestrictedSiteTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
