 ...
 */
public class AddSitesSite7Test extends BaseTestCase {
	public void testAddSitesSite7() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Open Site7 Name"),
			selenium.getText(
				"//li[contains(@class, 'social-office-enabled')]/span[contains(.,'Open Site7 Name')]/a"));
	}
}