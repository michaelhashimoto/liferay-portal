 ...
 */
public class SOUs_SendMemberRequestSite1PublicRestrictTest extends BaseTestCase {
	public void testSOUs_SendMemberRequestSite1PublicRestrict()
		throws Exception {
		...
		assertTrue(selenium.getConfirmation()
						   .matches("^This is a restricted site. Do you want to send a membership request to Public Restricted Site1 Name[\\s\\S]$"));
