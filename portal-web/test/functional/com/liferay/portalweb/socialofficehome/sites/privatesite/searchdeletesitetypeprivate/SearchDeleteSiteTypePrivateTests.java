...
package com.liferay.portalweb.socialofficehome.sites.privatesite.searchdeletesitetypeprivate;
 ...
 */
public class SearchDeleteSiteTypePrivateTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddSitesSiteTypePrivateTest.class);
		testSuite.addTestSuite(DeleteSiteTypePrivateTest.class);
		testSuite.addTestSuite(SearchDeleteSiteTypePrivateTest.class);
