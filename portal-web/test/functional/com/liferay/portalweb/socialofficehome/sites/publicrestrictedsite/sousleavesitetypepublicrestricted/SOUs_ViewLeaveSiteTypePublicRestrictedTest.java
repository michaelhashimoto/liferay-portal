 ...
 */
public class SOUs_ViewLeaveSiteTypePublicRestrictedTest extends BaseTestCase {
	public void testSOUs_ViewLeaveSiteTypePublicRestricted()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText(
				"xPath=(//span[@class='description'])[contains(.,'Public Restricted Site Description')]"));
		assertTrue(selenium.isVisible("//a[@class='request-site']"));
		selenium.clickAt("xPath=(//span[@class='name']/a)[contains(.,'Public Restricted Site Name')]",
			RuntimeVariables.replace("Public Restricted Site Name"));
