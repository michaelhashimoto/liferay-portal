 ...
 */
public class SOUs_JoinSitesSite1Test extends BaseTestCase {
	public void testSOUs_JoinSitesSite1() throws Exception {
		...
		assertTrue(selenium.getConfirmation()
						   .matches("^Are you sure you want to join Open Site1 Name[\\s\\S]$"));
