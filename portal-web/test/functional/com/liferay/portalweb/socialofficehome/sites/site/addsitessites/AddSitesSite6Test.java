 ...
 */
public class AddSitesSite6Test extends BaseTestCase {
	public void testAddSitesSite6() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Open Site6 Name"),
			selenium.getText(
				"//li[contains(@class, 'social-office-enabled')]/span[contains(.,'Open Site6 Name')]/a"));
	}
}