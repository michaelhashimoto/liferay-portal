 ...
 */
public class DeleteSiteTypePrivateRestrictedTest extends BaseTestCase {
	public void testDeleteSiteTypePrivateRestricted() throws Exception {
		...
		assertTrue(selenium.getConfirmation()
						   .matches("^Are you sure you want to delete Private Restricted Site Name[\\s\\S]$"));
