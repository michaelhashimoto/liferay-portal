 ...
 */
public class SOUs_FavoriteSite1Tests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SOUs_JoinSitesSite1Test.class);
		testSuite.addTestSuite(SOUs_FavoriteSite1Test.class);
		testSuite.addTestSuite(SOUs_AddSitesSite2Test.class);
		testSuite.addTestSuite(SOUs_ViewFavoriteSite1Test.class);
