 ...
 */
public class SOUs_ViewWHEntryContentViewableByEveryoneTests
	...
	public static Test suite() {
		...
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ReplyMicroblogsContentMentionsTest.class);
		testSuite.addTestSuite(SOUs_AddMicroblogsContentViewableByEveryoneTest.class);
