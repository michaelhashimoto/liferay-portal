 ...
 */
public class AddPortletTPTest extends BaseTestCase {
	public void testAddPortletTP() throws Exception {
		...
		selenium.keyUp("//input[@id='layout_configuration_content']",
			RuntimeVariables.replace("\\13"));
		selenium.waitForVisible("//div[@title='Test PACL']/p/a");
		selenium.clickAt("//div[@title='Test PACL']/p/a",
