 ...
 */
public class AddPortletKBSrTest extends BaseTestCase {
	public void testAddPortletKBSr() throws Exception {
		...
		selenium.waitForVisible("//div[@title='Knowledge Base Search']/p/a");
