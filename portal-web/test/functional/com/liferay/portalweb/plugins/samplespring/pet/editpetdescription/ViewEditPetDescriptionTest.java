 ...
 */
public class ViewEditPetDescriptionTest extends BaseTestCase {
	public void testViewEditPetDescription() throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
				"Description: This is a *.txt document. This is a *.txt document. This is a *.txt document. This is a *.txt document. This is a *.txt document. This is a *.txt document. This is a *.txt document. This is a *.txt document. This is a *.txt document. This is a *.txt document."),
