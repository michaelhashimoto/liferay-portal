 ...
 */
public class ViewNoWorkflowAddTaskCommentAssignedToMeTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ViewNoWorkflowAddTaskCommentAssignedToMeTest.class);
