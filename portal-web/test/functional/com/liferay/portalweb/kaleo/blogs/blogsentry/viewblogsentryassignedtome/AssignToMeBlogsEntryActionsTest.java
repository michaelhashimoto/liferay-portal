...
public class AssignToMeBlogsEntryActionsTest extends BaseTestCase {
	public void testAssignToMeBlogsEntryActions() throws Exception {
		...
		selenium.waitForVisible(
			"//div[@class='lfr-component lfr-menu-list']/ul/li[1]/a[contains(.,'Assign to Me')]");
		assertEquals(RuntimeVariables.replace("Assign to Me"),
			selenium.getText(
				"//div[@class='lfr-component lfr-menu-list']/ul/li[1]/a[contains(.,'Assign to Me')]"));
		selenium.clickAt("//div[@class='lfr-component lfr-menu-list']/ul/li[1]/a[contains(.,'Assign to Me')]",
