 ...
 */
public class ViewWebContentTaskActivitiesAssignedToMeTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ViewWebContentTaskActivitiesAssignedToMeTest.class);
