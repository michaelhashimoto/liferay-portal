 ...
 */
public class AssignToMeWebContentAssignedUserTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AssignToMeWebContentAssignedUserTest.class);
		testSuite.addTestSuite(ViewWebContentAssignedToMeTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(UserSN_SignInTest.class);
		testSuite.addTestSuite(UserSN_ViewWebContentAssignedToMeTest.class);
		testSuite.addTestSuite(SignOutTest.class);
