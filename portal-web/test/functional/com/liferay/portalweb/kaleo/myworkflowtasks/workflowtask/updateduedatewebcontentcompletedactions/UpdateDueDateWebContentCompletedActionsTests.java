 ...
 */
public class UpdateDueDateWebContentCompletedActionsTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(UpdateDueDateWebContentCompletedActionsTest.class);
