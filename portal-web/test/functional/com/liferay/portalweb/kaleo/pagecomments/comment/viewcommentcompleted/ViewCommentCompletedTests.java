...
import com.liferay.portalweb.kaleo.pagecomments.comment.viewcommentassignedtome.AddCommentTest;
import com.liferay.portalweb.kaleo.pagecomments.comment.viewcommentassignedtome.AssignToMeCommentActionsTest;
 ...
 */
public class ViewCommentCompletedTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ApproveCommentActionsTest.class);
		testSuite.addTestSuite(ViewCommentCompletedTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(Guest_ViewCommentCompletedTest.class);
