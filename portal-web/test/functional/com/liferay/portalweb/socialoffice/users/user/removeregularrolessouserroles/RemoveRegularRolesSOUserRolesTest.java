 ...
 */
public class RemoveRegularRolesSOUserRolesTest extends BaseTestCase {
	public void testRemoveRegularRolesSOUserRoles() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.waitForVisible("//a[contains(.,'Current')]");
				assertEquals(RuntimeVariables.replace("Current"),
					selenium.getText("//a[contains(.,'Current')]"));
				selenium.clickAt("//a[contains(.,'Current')]",
