 ...
 */
public class SOUs2_ViewPageBlogsTemplateSiteTest extends BaseTestCase {
	public void testSOUs2_ViewPageBlogsTemplateSite() throws Exception {
		...
		assertFalse(selenium.isTextPresent("Blogs Test Page"));
	}
}