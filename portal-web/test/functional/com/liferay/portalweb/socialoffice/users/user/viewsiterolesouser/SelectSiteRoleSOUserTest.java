 ...
 */
public class SelectSiteRoleSOUserTest extends BaseTestCase {
	public void testSelectSiteRoleSOUser() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				assertEquals(RuntimeVariables.replace("Roles Siterole Name"),
					selenium.getText("link=Roles Siterole Name"));
				selenium.click("link=Roles Siterole Name");
				selenium.selectWindow("null");
				selenium.waitForText("//tr[contains(., 'Roles Siterole Name')]/td",
					"Roles Siterole Name");
				assertEquals(RuntimeVariables.replace("Roles Siterole Name"),
					selenium.getText(
						"//tr[contains(., 'Roles Siterole Name')]/td"));
