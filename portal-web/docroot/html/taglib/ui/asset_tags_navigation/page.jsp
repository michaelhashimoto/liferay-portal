...
String tagsNavigation = _buildTagsNavigation(scopeGroupId, themeDisplay.getParentGroupId(), tag, portletURL, classNameId, displayStyle, maxAssetTags, showAssetCount, showZeroAssetCount);
...
<%!
private String _buildTagsNavigation(long scopeGroupId, long parentGroupId, String selectedTagName, PortletURL portletURL, long classNameId, String displayStyle, int maxAssetTags, boolean showAssetCount, boolean showZeroAssetCount) throws Exception {
	...
	if (showAssetCount && (classNameId > 0)) {
		...
		tags = AssetTagServiceUtil.getGroupTags(parentGroupId, 0, maxAssetTags, new AssetTagCountComparator());
	}
