...
public class AssetCategoryPersistenceImpl extends BasePersistenceImpl<AssetCategory>
	...
	public List<AssetCategory> findByG_V(long groupId, long[] vocabularyIds,
		int start, int end, OrderByComparator orderByComparator)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_G_V;
		Object[] finderArgs = null;
	...
	public int countByG_P_V(long groupId, long parentCategoryId,
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_G_P_V,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_G_P_V,
					finderArgs, count);
	...
	public int countByG_P_N_V(long groupId, long parentCategoryId, String name,
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_G_P_N_V,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_G_P_N_V,
					finderArgs, count);
	...
	private static final String _FINDER_COLUMN_G_V_GROUPID_5 = "(" +
		_removeConjunction(_FINDER_COLUMN_G_V_GROUPID_2) + ")";
	...
	private static final String _FINDER_COLUMN_G_V_VOCABULARYID_5 = "(" +
		_removeConjunction(_FINDER_COLUMN_G_V_VOCABULARYID_2) + ")";
	...
	private static final String _FINDER_COLUMN_G_LIKEN_V_GROUPID_5 = "(" +
		_removeConjunction(_FINDER_COLUMN_G_LIKEN_V_GROUPID_2) + ")";
	...
	private static final String _FINDER_COLUMN_G_LIKEN_V_NAME_4 = "(" +
		_removeConjunction(_FINDER_COLUMN_G_LIKEN_V_NAME_1) + ")";
	private static final String _FINDER_COLUMN_G_LIKEN_V_NAME_5 = "(" +
		_removeConjunction(_FINDER_COLUMN_G_LIKEN_V_NAME_2) + ")";
	private static final String _FINDER_COLUMN_G_LIKEN_V_NAME_6 = "(" +
		_removeConjunction(_FINDER_COLUMN_G_LIKEN_V_NAME_3) + ")";
	...
	private static final String _FINDER_COLUMN_G_LIKEN_V_VOCABULARYID_5 = "(" +
		_removeConjunction(_FINDER_COLUMN_G_LIKEN_V_VOCABULARYID_2) + ")";
