...
public abstract class GroupLocalServiceBaseImpl extends BaseLocalServiceImpl
	...
	public void addPermissionGroup(long permissionId, long groupId)
		throws SystemException {
		permissionPersistence.addGroup(permissionId, groupId);
	}

	/**
	 * @throws SystemException if a system exception occurred
	 */
	public void addPermissionGroup(long permissionId, Group group)
		throws SystemException {
		permissionPersistence.addGroup(permissionId, group);
	}
	...
	public void addPermissionGroups(long permissionId, long[] groupIds)
		throws SystemException {
		permissionPersistence.addGroups(permissionId, groupIds);
	}

	/**
	 * @throws SystemException if a system exception occurred
	 */
	public void addPermissionGroups(long permissionId, List<Group> Groups)
		throws SystemException {
		permissionPersistence.addGroups(permissionId, Groups);
	}
	...
	public void clearPermissionGroups(long permissionId)
		throws SystemException {
		permissionPersistence.clearGroups(permissionId);
	}
	...
	public void deletePermissionGroup(long permissionId, long groupId)
		throws SystemException {
		permissionPersistence.removeGroup(permissionId, groupId);
	}

	/**
	 * @throws SystemException if a system exception occurred
	 */
	public void deletePermissionGroup(long permissionId, Group group)
		throws SystemException {
		permissionPersistence.removeGroup(permissionId, group);
	}
	...
	public void deletePermissionGroups(long permissionId, long[] groupIds)
		throws SystemException {
		permissionPersistence.removeGroups(permissionId, groupIds);
	}

	/**
	 * @throws SystemException if a system exception occurred
	 */
	public void deletePermissionGroups(long permissionId, List<Group> Groups)
		throws SystemException {
		permissionPersistence.removeGroups(permissionId, Groups);
	}
	...
	public List<Group> getPermissionGroups(long permissionId)
		throws SystemException {
		return permissionPersistence.getGroups(permissionId);
	}

	/**
	 * @throws SystemException if a system exception occurred
	 */
	public List<Group> getPermissionGroups(long permissionId, int start, int end)
		throws SystemException {
		return permissionPersistence.getGroups(permissionId, start, end);
	}

	/**
	 * @throws SystemException if a system exception occurred
	 */
	public List<Group> getPermissionGroups(long permissionId, int start,
		int end, OrderByComparator orderByComparator) throws SystemException {
		return permissionPersistence.getGroups(permissionId, start, end,
			orderByComparator);
	}
	...
	public int getPermissionGroupsCount(long permissionId)
		throws SystemException {
		return permissionPersistence.getGroupsSize(permissionId);
	}
	...
	public boolean hasPermissionGroup(long permissionId, long groupId)
		throws SystemException {
		return permissionPersistence.containsGroup(permissionId, groupId);
	}
	...
	public boolean hasPermissionGroups(long permissionId)
		throws SystemException {
		return permissionPersistence.containsGroups(permissionId);
	}
	...
	public void setPermissionGroups(long permissionId, long[] groupIds)
		throws SystemException {
		permissionPersistence.setGroups(permissionId, groupIds);
	}
