...
public class SCProductVersionPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<SCProductVersion> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_scProductVersions.add(_persistence.update(newSCProductVersion, false));
	...
	protected SCProductVersion addSCProductVersion() throws Exception {
		...
		_scProductVersions.add(_persistence.update(scProductVersion, false));
	...
	private ModelListener<SCProductVersion>[] _listeners;
