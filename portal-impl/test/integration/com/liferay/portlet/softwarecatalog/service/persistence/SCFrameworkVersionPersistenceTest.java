...
public class SCFrameworkVersionPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<SCFrameworkVersion> modelListener : _listeners) {
	...
	protected SCFrameworkVersion addSCFrameworkVersion()
		...
		_scFrameworkVersions.add(_persistence.update(scFrameworkVersion, false));
	...
	private ModelListener<SCFrameworkVersion>[] _listeners;
