...
public class SCProductScreenshotPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<SCProductScreenshot> modelListener : _listeners) {
	...
	protected SCProductScreenshot addSCProductScreenshot()
		...
		_scProductScreenshots.add(_persistence.update(scProductScreenshot, false));
	...
	private ModelListener<SCProductScreenshot>[] _listeners;
