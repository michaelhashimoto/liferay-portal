...
public class SCProductEntryPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<SCProductEntry> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_scProductEntries.add(_persistence.update(newSCProductEntry, false));
	...
	protected SCProductEntry addSCProductEntry() throws Exception {
		...
		_scProductEntries.add(_persistence.update(scProductEntry, false));
	...
	private ModelListener<SCProductEntry>[] _listeners;
