...
public class SCLicensePersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<SCLicense> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_scLicenses.add(_persistence.update(newSCLicense, false));
	...
	protected SCLicense addSCLicense() throws Exception {
		...
		_scLicenses.add(_persistence.update(scLicense, false));
	...
	private ModelListener<SCLicense>[] _listeners;
