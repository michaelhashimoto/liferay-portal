...
public class ShoppingItemPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<ShoppingItem> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_shoppingItems.add(_persistence.update(newShoppingItem, false));
	...
	protected ShoppingItem addShoppingItem() throws Exception {
		...
		_shoppingItems.add(_persistence.update(shoppingItem, false));
	...
	private ModelListener<ShoppingItem>[] _listeners;
