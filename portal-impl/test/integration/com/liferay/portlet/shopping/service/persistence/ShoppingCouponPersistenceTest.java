...
public class ShoppingCouponPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<ShoppingCoupon> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_shoppingCoupons.add(_persistence.update(newShoppingCoupon, false));
	...
	protected ShoppingCoupon addShoppingCoupon() throws Exception {
		...
		_shoppingCoupons.add(_persistence.update(shoppingCoupon, false));
	...
	private ModelListener<ShoppingCoupon>[] _listeners;
