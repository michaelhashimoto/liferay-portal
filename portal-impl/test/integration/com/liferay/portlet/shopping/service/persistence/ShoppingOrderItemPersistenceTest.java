...
public class ShoppingOrderItemPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<ShoppingOrderItem> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_shoppingOrderItems.add(_persistence.update(newShoppingOrderItem, false));
	...
	protected ShoppingOrderItem addShoppingOrderItem()
		...
		_shoppingOrderItems.add(_persistence.update(shoppingOrderItem, false));
	...
	private ModelListener<ShoppingOrderItem>[] _listeners;
