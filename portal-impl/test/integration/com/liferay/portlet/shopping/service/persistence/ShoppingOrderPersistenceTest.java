...
public class ShoppingOrderPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<ShoppingOrder> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_shoppingOrders.add(_persistence.update(newShoppingOrder, false));
	...
	protected ShoppingOrder addShoppingOrder() throws Exception {
		...
		_shoppingOrders.add(_persistence.update(shoppingOrder, false));
	...
	private ModelListener<ShoppingOrder>[] _listeners;
