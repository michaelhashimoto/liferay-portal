...
public class ShoppingCartPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<ShoppingCart> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_shoppingCarts.add(_persistence.update(newShoppingCart, false));
	...
	protected ShoppingCart addShoppingCart() throws Exception {
		...
		_shoppingCarts.add(_persistence.update(shoppingCart, false));
	...
	private ModelListener<ShoppingCart>[] _listeners;
