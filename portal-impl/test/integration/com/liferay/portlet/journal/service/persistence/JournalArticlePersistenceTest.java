...
public class JournalArticlePersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<JournalArticle> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_journalArticles.add(_persistence.update(newJournalArticle, false));
	...
	protected JournalArticle addJournalArticle() throws Exception {
		...
		_journalArticles.add(_persistence.update(journalArticle, false));
	...
	private ModelListener<JournalArticle>[] _listeners;
