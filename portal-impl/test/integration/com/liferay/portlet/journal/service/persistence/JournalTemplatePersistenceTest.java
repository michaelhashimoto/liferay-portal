...
public class JournalTemplatePersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<JournalTemplate> modelListener : _listeners) {
	...
	public void tearDown() throws Exception {
		Iterator<JournalTemplate> iterator = _journalTemplates.iterator();
	...
	public void testUpdateExisting() throws Exception {
		...
		_journalTemplates.add(_persistence.update(newJournalTemplate, false));
	...
	protected JournalTemplate addJournalTemplate() throws Exception {
		...
		_journalTemplates.add(_persistence.update(journalTemplate, false));

		return journalTemplate;
	}

	private static Log _log = LogFactoryUtil.getLog(JournalTemplatePersistenceTest.class);
	private List<JournalTemplate> _journalTemplates = new ArrayList<JournalTemplate>();
	private ModelListener<JournalTemplate>[] _listeners;
