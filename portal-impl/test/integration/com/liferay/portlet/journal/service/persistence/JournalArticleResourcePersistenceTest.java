...
public class JournalArticleResourcePersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<JournalArticleResource> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_journalArticleResources.add(_persistence.update(
				newJournalArticleResource, false));
	...
	private ModelListener<JournalArticleResource>[] _listeners;
