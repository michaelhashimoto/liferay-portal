...
public class JournalFeedPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<JournalFeed> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_journalFeeds.add(_persistence.update(newJournalFeed, false));
	...
	protected JournalFeed addJournalFeed() throws Exception {
		...
		_journalFeeds.add(_persistence.update(journalFeed, false));
	...
	private ModelListener<JournalFeed>[] _listeners;
