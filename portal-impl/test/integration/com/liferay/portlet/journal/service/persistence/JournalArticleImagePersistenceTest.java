...
public class JournalArticleImagePersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<JournalArticleImage> modelListener : _listeners) {
	...
	protected JournalArticleImage addJournalArticleImage()
		...
		_journalArticleImages.add(_persistence.update(journalArticleImage, false));
	...
	private ModelListener<JournalArticleImage>[] _listeners;
