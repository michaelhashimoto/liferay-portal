...
public class JournalContentSearchPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<JournalContentSearch> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_journalContentSearchs.add(_persistence.update(
				newJournalContentSearch, false));
	...
	private ModelListener<JournalContentSearch>[] _listeners;
