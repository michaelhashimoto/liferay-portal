...
public class SocialActivityPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<SocialActivity> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_socialActivities.add(_persistence.update(newSocialActivity, false));
	...
	protected SocialActivity addSocialActivity() throws Exception {
		...
		_socialActivities.add(_persistence.update(socialActivity, false));
	...
	private ModelListener<SocialActivity>[] _listeners;
