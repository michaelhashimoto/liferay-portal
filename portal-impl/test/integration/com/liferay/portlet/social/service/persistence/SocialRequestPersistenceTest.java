...
public class SocialRequestPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<SocialRequest> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_socialRequests.add(_persistence.update(newSocialRequest, false));
	...
	protected SocialRequest addSocialRequest() throws Exception {
		...
		_socialRequests.add(_persistence.update(socialRequest, false));
	...
	private ModelListener<SocialRequest>[] _listeners;
