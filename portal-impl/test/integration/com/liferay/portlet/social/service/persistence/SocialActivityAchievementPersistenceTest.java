...
public class SocialActivityAchievementPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<SocialActivityAchievement> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_socialActivityAchievements.add(_persistence.update(
				newSocialActivityAchievement, false));
	...
	private ModelListener<SocialActivityAchievement>[] _listeners;
