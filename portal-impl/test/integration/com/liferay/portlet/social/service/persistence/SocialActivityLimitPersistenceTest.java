...
public class SocialActivityLimitPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<SocialActivityLimit> modelListener : _listeners) {
	...
	protected SocialActivityLimit addSocialActivityLimit()
		...
		_socialActivityLimits.add(_persistence.update(socialActivityLimit, false));
	...
	private ModelListener<SocialActivityLimit>[] _listeners;
