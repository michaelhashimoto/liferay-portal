...
public class SocialRelationPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<SocialRelation> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_socialRelations.add(_persistence.update(newSocialRelation, false));
	...
	protected SocialRelation addSocialRelation() throws Exception {
		...
		_socialRelations.add(_persistence.update(socialRelation, false));
	...
	private ModelListener<SocialRelation>[] _listeners;
