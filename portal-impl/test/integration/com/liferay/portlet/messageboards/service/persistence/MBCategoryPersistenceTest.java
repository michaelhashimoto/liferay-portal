...
public class MBCategoryPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<MBCategory> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_mbCategories.add(_persistence.update(newMBCategory, false));
	...
	protected MBCategory addMBCategory() throws Exception {
		...
		_mbCategories.add(_persistence.update(mbCategory, false));
	...
	private ModelListener<MBCategory>[] _listeners;
