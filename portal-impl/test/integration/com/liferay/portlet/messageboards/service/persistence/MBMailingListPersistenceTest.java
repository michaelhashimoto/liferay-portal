...
public class MBMailingListPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<MBMailingList> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_mbMailingLists.add(_persistence.update(newMBMailingList, false));
	...
	protected MBMailingList addMBMailingList() throws Exception {
		...
		_mbMailingLists.add(_persistence.update(mbMailingList, false));
	...
	private ModelListener<MBMailingList>[] _listeners;
