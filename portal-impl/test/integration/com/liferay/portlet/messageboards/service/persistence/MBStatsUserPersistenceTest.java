...
public class MBStatsUserPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<MBStatsUser> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_mbStatsUsers.add(_persistence.update(newMBStatsUser, false));
	...
	protected MBStatsUser addMBStatsUser() throws Exception {
		...
		_mbStatsUsers.add(_persistence.update(mbStatsUser, false));
	...
	private ModelListener<MBStatsUser>[] _listeners;
