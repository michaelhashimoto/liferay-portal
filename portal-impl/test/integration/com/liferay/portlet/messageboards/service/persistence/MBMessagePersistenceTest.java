...
public class MBMessagePersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<MBMessage> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_mbMessages.add(_persistence.update(newMBMessage, false));
	...
	protected MBMessage addMBMessage() throws Exception {
		...
		_mbMessages.add(_persistence.update(mbMessage, false));
	...
	private ModelListener<MBMessage>[] _listeners;
