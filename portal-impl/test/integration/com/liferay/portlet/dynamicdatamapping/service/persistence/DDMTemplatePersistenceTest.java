...
public class DDMTemplatePersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<DDMTemplate> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_ddmTemplates.add(_persistence.update(newDDMTemplate, false));
	...
	protected DDMTemplate addDDMTemplate() throws Exception {
		...
		_ddmTemplates.add(_persistence.update(ddmTemplate, false));
	...
	private ModelListener<DDMTemplate>[] _listeners;
