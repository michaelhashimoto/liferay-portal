...
public class DDMStorageLinkPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<DDMStorageLink> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_ddmStorageLinks.add(_persistence.update(newDDMStorageLink, false));
	...
	protected DDMStorageLink addDDMStorageLink() throws Exception {
		...
		_ddmStorageLinks.add(_persistence.update(ddmStorageLink, false));
	...
	private ModelListener<DDMStorageLink>[] _listeners;
