...
public class DDMStructurePersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<DDMStructure> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_ddmStructures.add(_persistence.update(newDDMStructure, false));
	...
	protected DDMStructure addDDMStructure() throws Exception {
		...
		_ddmStructures.add(_persistence.update(ddmStructure, false));
	...
	private ModelListener<DDMStructure>[] _listeners;
