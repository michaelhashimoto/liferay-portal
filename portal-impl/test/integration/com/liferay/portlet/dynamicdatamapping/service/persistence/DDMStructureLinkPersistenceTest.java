...
public class DDMStructureLinkPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<DDMStructureLink> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_ddmStructureLinks.add(_persistence.update(newDDMStructureLink, false));
	...
	protected DDMStructureLink addDDMStructureLink() throws Exception {
		...
		_ddmStructureLinks.add(_persistence.update(ddmStructureLink, false));
	...
	private ModelListener<DDMStructureLink>[] _listeners;
