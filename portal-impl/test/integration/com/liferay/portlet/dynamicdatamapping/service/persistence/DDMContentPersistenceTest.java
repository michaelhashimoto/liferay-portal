...
public class DDMContentPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<DDMContent> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_ddmContents.add(_persistence.update(newDDMContent, false));
	...
	protected DDMContent addDDMContent() throws Exception {
		...
		_ddmContents.add(_persistence.update(ddmContent, false));
	...
	private ModelListener<DDMContent>[] _listeners;
