...
public class DDLRecordSetPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<DDLRecordSet> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_ddlRecordSets.add(_persistence.update(newDDLRecordSet, false));
	...
	protected DDLRecordSet addDDLRecordSet() throws Exception {
		...
		_ddlRecordSets.add(_persistence.update(ddlRecordSet, false));
	...
	private ModelListener<DDLRecordSet>[] _listeners;
