...
public class DDLRecordVersionPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<DDLRecordVersion> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_ddlRecordVersions.add(_persistence.update(newDDLRecordVersion, false));
	...
	protected DDLRecordVersion addDDLRecordVersion() throws Exception {
		...
		_ddlRecordVersions.add(_persistence.update(ddlRecordVersion, false));
	...
	private ModelListener<DDLRecordVersion>[] _listeners;
