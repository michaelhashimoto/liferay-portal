...
public class DDLRecordPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<DDLRecord> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_ddlRecords.add(_persistence.update(newDDLRecord, false));
	...
	protected DDLRecord addDDLRecord() throws Exception {
		...
		_ddlRecords.add(_persistence.update(ddlRecord, false));
	...
	private ModelListener<DDLRecord>[] _listeners;
