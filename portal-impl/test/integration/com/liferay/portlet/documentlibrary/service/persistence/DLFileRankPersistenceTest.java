...
public class DLFileRankPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<DLFileRank> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_dlFileRanks.add(_persistence.update(newDLFileRank, false));
	...
	protected DLFileRank addDLFileRank() throws Exception {
		...
		_dlFileRanks.add(_persistence.update(dlFileRank, false));
	...
	private ModelListener<DLFileRank>[] _listeners;
