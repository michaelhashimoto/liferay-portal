...
public class DLFolderPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<DLFolder> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_dlFolders.add(_persistence.update(newDLFolder, false));
	...
	protected DLFolder addDLFolder() throws Exception {
		...
		_dlFolders.add(_persistence.update(dlFolder, false));
	...
	private ModelListener<DLFolder>[] _listeners;
