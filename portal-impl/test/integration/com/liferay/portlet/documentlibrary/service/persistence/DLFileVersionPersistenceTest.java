...
public class DLFileVersionPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<DLFileVersion> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_dlFileVersions.add(_persistence.update(newDLFileVersion, false));
	...
	protected DLFileVersion addDLFileVersion() throws Exception {
		...
		_dlFileVersions.add(_persistence.update(dlFileVersion, false));
	...
	private ModelListener<DLFileVersion>[] _listeners;
