...
public class DLFileShortcutPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<DLFileShortcut> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_dlFileShortcuts.add(_persistence.update(newDLFileShortcut, false));
	...
	protected DLFileShortcut addDLFileShortcut() throws Exception {
		...
		_dlFileShortcuts.add(_persistence.update(dlFileShortcut, false));
	...
	private ModelListener<DLFileShortcut>[] _listeners;
