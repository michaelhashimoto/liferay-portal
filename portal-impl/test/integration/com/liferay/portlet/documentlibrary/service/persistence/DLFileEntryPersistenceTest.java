...
public class DLFileEntryPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<DLFileEntry> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_dlFileEntries.add(_persistence.update(newDLFileEntry, false));
	...
	protected DLFileEntry addDLFileEntry() throws Exception {
		...
		_dlFileEntries.add(_persistence.update(dlFileEntry, false));
	...
	private ModelListener<DLFileEntry>[] _listeners;
