...
public class BlogsStatsUserPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<BlogsStatsUser> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_blogsStatsUsers.add(_persistence.update(newBlogsStatsUser, false));
	...
	protected BlogsStatsUser addBlogsStatsUser() throws Exception {
		...
		_blogsStatsUsers.add(_persistence.update(blogsStatsUser, false));
	...
	private ModelListener<BlogsStatsUser>[] _listeners;
