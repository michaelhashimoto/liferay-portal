...
public class BlogsEntryPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<BlogsEntry> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_blogsEntries.add(_persistence.update(newBlogsEntry, false));
	...
	protected BlogsEntry addBlogsEntry() throws Exception {
		...
		_blogsEntries.add(_persistence.update(blogsEntry, false));
	...
	private ModelListener<BlogsEntry>[] _listeners;
