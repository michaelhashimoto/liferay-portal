...
public class MDRRuleGroupPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<MDRRuleGroup> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_mdrRuleGroups.add(_persistence.update(newMDRRuleGroup, false));
	...
	protected MDRRuleGroup addMDRRuleGroup() throws Exception {
		...
		_mdrRuleGroups.add(_persistence.update(mdrRuleGroup, false));
	...
	private ModelListener<MDRRuleGroup>[] _listeners;
