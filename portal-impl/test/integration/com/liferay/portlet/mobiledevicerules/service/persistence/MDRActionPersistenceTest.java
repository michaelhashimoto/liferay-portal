...
public class MDRActionPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<MDRAction> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_mdrActions.add(_persistence.update(newMDRAction, false));
	...
	protected MDRAction addMDRAction() throws Exception {
		...
		_mdrActions.add(_persistence.update(mdrAction, false));
	...
	private ModelListener<MDRAction>[] _listeners;
