...
public class MDRRuleGroupInstancePersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<MDRRuleGroupInstance> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_mdrRuleGroupInstances.add(_persistence.update(
				newMDRRuleGroupInstance, false));
	...
	private ModelListener<MDRRuleGroupInstance>[] _listeners;
