...
public class MDRRulePersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<MDRRule> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_mdrRules.add(_persistence.update(newMDRRule, false));
	...
	protected MDRRule addMDRRule() throws Exception {
		...
		_mdrRules.add(_persistence.update(mdrRule, false));
	...
	private ModelListener<MDRRule>[] _listeners;
