...
public class RatingsEntryPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<RatingsEntry> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_ratingsEntries.add(_persistence.update(newRatingsEntry, false));
	...
	protected RatingsEntry addRatingsEntry() throws Exception {
		...
		_ratingsEntries.add(_persistence.update(ratingsEntry, false));
	...
	private ModelListener<RatingsEntry>[] _listeners;
