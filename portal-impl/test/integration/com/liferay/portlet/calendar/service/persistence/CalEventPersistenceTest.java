...
public class CalEventPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<CalEvent> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_calEvents.add(_persistence.update(newCalEvent, false));
	...
	protected CalEvent addCalEvent() throws Exception {
		...
		_calEvents.add(_persistence.update(calEvent, false));
	...
	private ModelListener<CalEvent>[] _listeners;
