...
public class WikiNodePersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<WikiNode> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_wikiNodes.add(_persistence.update(newWikiNode, false));
	...
	protected WikiNode addWikiNode() throws Exception {
		...
		_wikiNodes.add(_persistence.update(wikiNode, false));
	...
	private ModelListener<WikiNode>[] _listeners;
