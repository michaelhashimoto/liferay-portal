...
public class WikiPageResourcePersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<WikiPageResource> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_wikiPageResources.add(_persistence.update(newWikiPageResource, false));
	...
	protected WikiPageResource addWikiPageResource() throws Exception {
		...
		_wikiPageResources.add(_persistence.update(wikiPageResource, false));
	...
	private ModelListener<WikiPageResource>[] _listeners;
