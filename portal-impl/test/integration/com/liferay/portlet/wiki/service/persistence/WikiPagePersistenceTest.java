...
public class WikiPagePersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<WikiPage> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_wikiPages.add(_persistence.update(newWikiPage, false));
	...
	protected WikiPage addWikiPage() throws Exception {
		...
		_wikiPages.add(_persistence.update(wikiPage, false));
	...
	private ModelListener<WikiPage>[] _listeners;
