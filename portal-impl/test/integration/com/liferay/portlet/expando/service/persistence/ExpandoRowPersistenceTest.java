...
public class ExpandoRowPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<ExpandoRow> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_expandoRows.add(_persistence.update(newExpandoRow, false));
	...
	protected ExpandoRow addExpandoRow() throws Exception {
		...
		_expandoRows.add(_persistence.update(expandoRow, false));
	...
	private ModelListener<ExpandoRow>[] _listeners;
