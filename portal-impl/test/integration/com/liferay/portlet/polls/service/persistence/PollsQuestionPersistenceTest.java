...
public class PollsQuestionPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<PollsQuestion> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_pollsQuestions.add(_persistence.update(newPollsQuestion, false));
	...
	protected PollsQuestion addPollsQuestion() throws Exception {
		...
		_pollsQuestions.add(_persistence.update(pollsQuestion, false));
	...
	private ModelListener<PollsQuestion>[] _listeners;
