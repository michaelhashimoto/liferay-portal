...
public class AnnouncementsDeliveryPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<AnnouncementsDelivery> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_announcementsDeliveries.add(_persistence.update(
				newAnnouncementsDelivery, false));
	...
	private ModelListener<AnnouncementsDelivery>[] _listeners;
