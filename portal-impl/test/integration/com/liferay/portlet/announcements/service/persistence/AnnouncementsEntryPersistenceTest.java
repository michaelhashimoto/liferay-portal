...
public class AnnouncementsEntryPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<AnnouncementsEntry> modelListener : _listeners) {
	...
	protected AnnouncementsEntry addAnnouncementsEntry()
		...
		_announcementsEntries.add(_persistence.update(announcementsEntry, false));
	...
	private ModelListener<AnnouncementsEntry>[] _listeners;
