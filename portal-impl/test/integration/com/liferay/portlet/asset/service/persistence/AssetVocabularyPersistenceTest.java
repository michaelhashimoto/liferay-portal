...
public class AssetVocabularyPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<AssetVocabulary> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_assetVocabularies.add(_persistence.update(newAssetVocabulary, false));
	...
	protected AssetVocabulary addAssetVocabulary() throws Exception {
		...
		_assetVocabularies.add(_persistence.update(assetVocabulary, false));
	...
	private ModelListener<AssetVocabulary>[] _listeners;
