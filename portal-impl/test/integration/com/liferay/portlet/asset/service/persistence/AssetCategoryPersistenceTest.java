...
public class AssetCategoryPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<AssetCategory> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_assetCategories.add(_persistence.update(newAssetCategory, false));
	...
	protected AssetCategory addAssetCategory() throws Exception {
		...
		_assetCategories.add(_persistence.update(assetCategory, false));
	...
	private ModelListener<AssetCategory>[] _listeners;
