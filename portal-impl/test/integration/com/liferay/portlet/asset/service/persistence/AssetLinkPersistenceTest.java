...
public class AssetLinkPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<AssetLink> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_assetLinks.add(_persistence.update(newAssetLink, false));
	...
	protected AssetLink addAssetLink() throws Exception {
		...
		_assetLinks.add(_persistence.update(assetLink, false));
	...
	private ModelListener<AssetLink>[] _listeners;
