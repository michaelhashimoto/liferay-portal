...
public class AssetTagPropertyPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<AssetTagProperty> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_assetTagProperties.add(_persistence.update(newAssetTagProperty, false));
	...
	protected AssetTagProperty addAssetTagProperty() throws Exception {
		...
		_assetTagProperties.add(_persistence.update(assetTagProperty, false));
	...
	private ModelListener<AssetTagProperty>[] _listeners;
