...
public class AssetEntryPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<AssetEntry> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_assetEntries.add(_persistence.update(newAssetEntry, false));
	...
	protected AssetEntry addAssetEntry() throws Exception {
		...
		_assetEntries.add(_persistence.update(assetEntry, false));
	...
	private ModelListener<AssetEntry>[] _listeners;
