...
public class AssetTagPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<AssetTag> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_assetTags.add(_persistence.update(newAssetTag, false));
	...
	protected AssetTag addAssetTag() throws Exception {
		...
		_assetTags.add(_persistence.update(assetTag, false));
	...
	private ModelListener<AssetTag>[] _listeners;
