...
public class BookmarksEntryPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<BookmarksEntry> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_bookmarksEntries.add(_persistence.update(newBookmarksEntry, false));
	...
	protected BookmarksEntry addBookmarksEntry() throws Exception {
		...
		_bookmarksEntries.add(_persistence.update(bookmarksEntry, false));
	...
	private ModelListener<BookmarksEntry>[] _listeners;
