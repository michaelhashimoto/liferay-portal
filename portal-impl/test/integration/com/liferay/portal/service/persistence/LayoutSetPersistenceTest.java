...
public class LayoutSetPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<LayoutSet> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_layoutSets.add(_persistence.update(newLayoutSet, false));
	...
	protected LayoutSet addLayoutSet() throws Exception {
		...
		_layoutSets.add(_persistence.update(layoutSet, false));
	...
	private ModelListener<LayoutSet>[] _listeners;
