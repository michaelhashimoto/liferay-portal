...
public class OrganizationPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<Organization> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_organizations.add(_persistence.update(newOrganization, false));
	...
	protected Organization addOrganization() throws Exception {
		...
		_organizations.add(_persistence.update(organization, false));
	...
	private ModelListener<Organization>[] _listeners;
