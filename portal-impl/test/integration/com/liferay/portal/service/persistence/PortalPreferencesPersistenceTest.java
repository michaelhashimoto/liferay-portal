...
public class PortalPreferencesPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<PortalPreferences> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_portalPreferenceses.add(_persistence.update(newPortalPreferences, false));
	...
	protected PortalPreferences addPortalPreferences()
		...
		_portalPreferenceses.add(_persistence.update(portalPreferences, false));
	...
	private ModelListener<PortalPreferences>[] _listeners;
