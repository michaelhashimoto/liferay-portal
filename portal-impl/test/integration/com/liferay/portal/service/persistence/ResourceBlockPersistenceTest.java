...
public class ResourceBlockPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<ResourceBlock> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_resourceBlocks.add(_persistence.update(newResourceBlock, false));
	...
	protected ResourceBlock addResourceBlock() throws Exception {
		...
		_resourceBlocks.add(_persistence.update(resourceBlock, false));
	...
	private ModelListener<ResourceBlock>[] _listeners;
