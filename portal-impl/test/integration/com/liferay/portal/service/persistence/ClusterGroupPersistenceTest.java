...
public class ClusterGroupPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<ClusterGroup> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_clusterGroups.add(_persistence.update(newClusterGroup, false));
	...
	protected ClusterGroup addClusterGroup() throws Exception {
		...
		_clusterGroups.add(_persistence.update(clusterGroup, false));
	...
	private ModelListener<ClusterGroup>[] _listeners;
