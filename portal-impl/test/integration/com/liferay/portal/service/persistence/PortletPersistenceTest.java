...
public class PortletPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<Portlet> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_portlets.add(_persistence.update(newPortlet, false));
	...
	protected Portlet addPortlet() throws Exception {
		...
		_portlets.add(_persistence.update(portlet, false));
	...
	private ModelListener<Portlet>[] _listeners;
