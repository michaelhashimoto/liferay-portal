...
public class UserTrackerPathPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<UserTrackerPath> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_userTrackerPaths.add(_persistence.update(newUserTrackerPath, false));
	...
	protected UserTrackerPath addUserTrackerPath() throws Exception {
		...
		_userTrackerPaths.add(_persistence.update(userTrackerPath, false));
	...
	private ModelListener<UserTrackerPath>[] _listeners;
