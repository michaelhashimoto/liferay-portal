...
public class ImagePersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<Image> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_images.add(_persistence.update(newImage, false));
	...
	protected Image addImage() throws Exception {
		...
		_images.add(_persistence.update(image, false));
	...
	private ModelListener<Image>[] _listeners;
