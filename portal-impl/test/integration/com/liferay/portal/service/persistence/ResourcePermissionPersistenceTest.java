...
public class ResourcePermissionPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<ResourcePermission> modelListener : _listeners) {
	...
	protected ResourcePermission addResourcePermission()
		...
		_resourcePermissions.add(_persistence.update(resourcePermission, false));
	...
	private ModelListener<ResourcePermission>[] _listeners;
