...
public class ResourceTypePermissionPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<ResourceTypePermission> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_resourceTypePermissions.add(_persistence.update(
				newResourceTypePermission, false));
	...
	private ModelListener<ResourceTypePermission>[] _listeners;
