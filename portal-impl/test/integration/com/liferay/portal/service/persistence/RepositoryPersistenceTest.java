...
public class RepositoryPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<Repository> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_repositories.add(_persistence.update(newRepository, false));
	...
	protected Repository addRepository() throws Exception {
		...
		_repositories.add(_persistence.update(repository, false));
	...
	private ModelListener<Repository>[] _listeners;
