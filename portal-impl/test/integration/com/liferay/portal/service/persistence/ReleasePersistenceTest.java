...
public class ReleasePersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<Release> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_releases.add(_persistence.update(newRelease, false));
	...
	protected Release addRelease() throws Exception {
		...
		_releases.add(_persistence.update(release, false));
	...
	private ModelListener<Release>[] _listeners;
