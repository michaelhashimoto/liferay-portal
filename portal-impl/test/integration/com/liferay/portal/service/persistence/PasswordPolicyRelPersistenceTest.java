...
public class PasswordPolicyRelPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<PasswordPolicyRel> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_passwordPolicyRels.add(_persistence.update(newPasswordPolicyRel, false));
	...
	protected PasswordPolicyRel addPasswordPolicyRel()
		...
		_passwordPolicyRels.add(_persistence.update(passwordPolicyRel, false));
	...
	private ModelListener<PasswordPolicyRel>[] _listeners;
