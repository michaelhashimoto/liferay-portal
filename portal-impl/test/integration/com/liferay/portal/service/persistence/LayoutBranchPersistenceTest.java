...
public class LayoutBranchPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<LayoutBranch> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_layoutBranchs.add(_persistence.update(newLayoutBranch, false));
	...
	protected LayoutBranch addLayoutBranch() throws Exception {
		...
		_layoutBranchs.add(_persistence.update(layoutBranch, false));
	...
	private ModelListener<LayoutBranch>[] _listeners;
