...
public class WebDAVPropsPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<WebDAVProps> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_webDAVPropses.add(_persistence.update(newWebDAVProps, false));
	...
	protected WebDAVProps addWebDAVProps() throws Exception {
		...
		_webDAVPropses.add(_persistence.update(webDAVProps, false));
	...
	private ModelListener<WebDAVProps>[] _listeners;
