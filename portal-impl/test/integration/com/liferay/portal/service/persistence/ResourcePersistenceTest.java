...
public class ResourcePersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<Resource> modelListener : _listeners) {
	...
	public void testActionableDynamicQuery() throws Exception {
		...
		ActionableDynamicQuery actionableDynamicQuery = new ResourceActionableDynamicQuery() {
				@Override
	...
	private ModelListener<Resource>[] _listeners;
