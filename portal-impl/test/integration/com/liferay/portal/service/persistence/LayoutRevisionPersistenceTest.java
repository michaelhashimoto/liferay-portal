...
public class LayoutRevisionPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<LayoutRevision> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_layoutRevisions.add(_persistence.update(newLayoutRevision, false));
	...
	protected LayoutRevision addLayoutRevision() throws Exception {
		...
		_layoutRevisions.add(_persistence.update(layoutRevision, false));
	...
	private ModelListener<LayoutRevision>[] _listeners;
