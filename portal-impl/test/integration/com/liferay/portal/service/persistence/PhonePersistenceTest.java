...
public class PhonePersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<Phone> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_phones.add(_persistence.update(newPhone, false));
	...
	protected Phone addPhone() throws Exception {
		...
		_phones.add(_persistence.update(phone, false));
	...
	private ModelListener<Phone>[] _listeners;
