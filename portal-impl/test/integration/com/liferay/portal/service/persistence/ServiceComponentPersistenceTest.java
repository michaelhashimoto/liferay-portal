...
public class ServiceComponentPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<ServiceComponent> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_serviceComponents.add(_persistence.update(newServiceComponent, false));
	...
	protected ServiceComponent addServiceComponent() throws Exception {
		...
		_serviceComponents.add(_persistence.update(serviceComponent, false));
	...
	private ModelListener<ServiceComponent>[] _listeners;
