...
public class AddressPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<Address> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_addresses.add(_persistence.update(newAddress, false));
	...
	protected Address addAddress() throws Exception {
		...
		_addresses.add(_persistence.update(address, false));
	...
	private ModelListener<Address>[] _listeners;
