...
public class OrgLaborPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<OrgLabor> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_orgLabors.add(_persistence.update(newOrgLabor, false));
	...
	protected OrgLabor addOrgLabor() throws Exception {
		...
		_orgLabors.add(_persistence.update(orgLabor, false));
	...
	private ModelListener<OrgLabor>[] _listeners;
