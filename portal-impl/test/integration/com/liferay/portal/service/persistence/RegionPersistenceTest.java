...
public class RegionPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<Region> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_regions.add(_persistence.update(newRegion, false));
	...
	protected Region addRegion() throws Exception {
		...
		_regions.add(_persistence.update(region, false));
	...
	private ModelListener<Region>[] _listeners;
