...
public class CompanyPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<Company> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_companies.add(_persistence.update(newCompany, false));
	...
	protected Company addCompany() throws Exception {
		...
		_companies.add(_persistence.update(company, false));
	...
	private ModelListener<Company>[] _listeners;
