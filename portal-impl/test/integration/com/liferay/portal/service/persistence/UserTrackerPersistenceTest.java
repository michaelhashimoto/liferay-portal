...
public class UserTrackerPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<UserTracker> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_userTrackers.add(_persistence.update(newUserTracker, false));
	...
	protected UserTracker addUserTracker() throws Exception {
		...
		_userTrackers.add(_persistence.update(userTracker, false));
	...
	private ModelListener<UserTracker>[] _listeners;
