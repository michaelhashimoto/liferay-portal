...
public class SubscriptionPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<Subscription> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_subscriptions.add(_persistence.update(newSubscription, false));
	...
	protected Subscription addSubscription() throws Exception {
		...
		_subscriptions.add(_persistence.update(subscription, false));
	...
	private ModelListener<Subscription>[] _listeners;
