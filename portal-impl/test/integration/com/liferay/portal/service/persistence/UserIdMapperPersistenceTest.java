...
public class UserIdMapperPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<UserIdMapper> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_userIdMappers.add(_persistence.update(newUserIdMapper, false));
	...
	protected UserIdMapper addUserIdMapper() throws Exception {
		...
		_userIdMappers.add(_persistence.update(userIdMapper, false));
	...
	private ModelListener<UserIdMapper>[] _listeners;
