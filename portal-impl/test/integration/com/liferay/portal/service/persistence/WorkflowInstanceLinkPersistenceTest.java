...
public class WorkflowInstanceLinkPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<WorkflowInstanceLink> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_workflowInstanceLinks.add(_persistence.update(
				newWorkflowInstanceLink, false));
	...
	private ModelListener<WorkflowInstanceLink>[] _listeners;
