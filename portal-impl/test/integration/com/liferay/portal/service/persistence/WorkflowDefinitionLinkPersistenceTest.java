...
public class WorkflowDefinitionLinkPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<WorkflowDefinitionLink> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_workflowDefinitionLinks.add(_persistence.update(
				newWorkflowDefinitionLink, false));
	...
	private ModelListener<WorkflowDefinitionLink>[] _listeners;
