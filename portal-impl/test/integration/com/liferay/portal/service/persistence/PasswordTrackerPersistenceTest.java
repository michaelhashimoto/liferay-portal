...
public class PasswordTrackerPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<PasswordTracker> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_passwordTrackers.add(_persistence.update(newPasswordTracker, false));
	...
	protected PasswordTracker addPasswordTracker() throws Exception {
		...
		_passwordTrackers.add(_persistence.update(passwordTracker, false));
	...
	private ModelListener<PasswordTracker>[] _listeners;
