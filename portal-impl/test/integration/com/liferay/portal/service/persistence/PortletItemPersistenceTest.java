...
public class PortletItemPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<PortletItem> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_portletItems.add(_persistence.update(newPortletItem, false));
	...
	protected PortletItem addPortletItem() throws Exception {
		...
		_portletItems.add(_persistence.update(portletItem, false));
	...
	private ModelListener<PortletItem>[] _listeners;
