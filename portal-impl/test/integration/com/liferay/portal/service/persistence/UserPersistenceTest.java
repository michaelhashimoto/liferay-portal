...
public class UserPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<User> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_users.add(_persistence.update(newUser, false));
	...
	protected User addUser() throws Exception {
		...
		_users.add(_persistence.update(user, false));
	...
	private ModelListener<User>[] _listeners;
