...
public class PluginSettingPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<PluginSetting> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_pluginSettings.add(_persistence.update(newPluginSetting, false));
	...
	protected PluginSetting addPluginSetting() throws Exception {
		...
		_pluginSettings.add(_persistence.update(pluginSetting, false));
	...
	private ModelListener<PluginSetting>[] _listeners;
