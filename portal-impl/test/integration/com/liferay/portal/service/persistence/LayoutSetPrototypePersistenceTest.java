...
public class LayoutSetPrototypePersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<LayoutSetPrototype> modelListener : _listeners) {
	...
	protected LayoutSetPrototype addLayoutSetPrototype()
		...
		_layoutSetPrototypes.add(_persistence.update(layoutSetPrototype, false));
	...
	private ModelListener<LayoutSetPrototype>[] _listeners;
