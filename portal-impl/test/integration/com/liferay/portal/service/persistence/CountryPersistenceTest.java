...
public class CountryPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<Country> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_countries.add(_persistence.update(newCountry, false));
	...
	protected Country addCountry() throws Exception {
		...
		_countries.add(_persistence.update(country, false));
	...
	private ModelListener<Country>[] _listeners;
