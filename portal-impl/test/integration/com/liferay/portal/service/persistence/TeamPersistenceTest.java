...
public class TeamPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<Team> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_teams.add(_persistence.update(newTeam, false));
	...
	protected Team addTeam() throws Exception {
		...
		_teams.add(_persistence.update(team, false));
	...
	private ModelListener<Team>[] _listeners;
