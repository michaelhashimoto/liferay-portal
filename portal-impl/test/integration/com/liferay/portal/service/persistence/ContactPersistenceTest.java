...
public class ContactPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<Contact> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_contacts.add(_persistence.update(newContact, false));
	...
	protected Contact addContact() throws Exception {
		...
		_contacts.add(_persistence.update(contact, false));
	...
	private ModelListener<Contact>[] _listeners;
