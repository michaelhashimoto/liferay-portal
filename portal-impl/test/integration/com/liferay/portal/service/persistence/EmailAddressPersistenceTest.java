...
public class EmailAddressPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<EmailAddress> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_emailAddresses.add(_persistence.update(newEmailAddress, false));
	...
	protected EmailAddress addEmailAddress() throws Exception {
		...
		_emailAddresses.add(_persistence.update(emailAddress, false));
	...
	private ModelListener<EmailAddress>[] _listeners;
