...
public class AccountPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<Account> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_accounts.add(_persistence.update(newAccount, false));
	...
	protected Account addAccount() throws Exception {
		...
		_accounts.add(_persistence.update(account, false));
	...
	private ModelListener<Account>[] _listeners;
