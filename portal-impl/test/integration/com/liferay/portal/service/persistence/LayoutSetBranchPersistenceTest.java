...
public class LayoutSetBranchPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<LayoutSetBranch> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_layoutSetBranchs.add(_persistence.update(newLayoutSetBranch, false));
	...
	protected LayoutSetBranch addLayoutSetBranch() throws Exception {
		...
		_layoutSetBranchs.add(_persistence.update(layoutSetBranch, false));
	...
	private ModelListener<LayoutSetBranch>[] _listeners;
