...
public class ResourceActionPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<ResourceAction> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_resourceActions.add(_persistence.update(newResourceAction, false));
	...
	protected ResourceAction addResourceAction() throws Exception {
		...
		_resourceActions.add(_persistence.update(resourceAction, false));
	...
	private ModelListener<ResourceAction>[] _listeners;
