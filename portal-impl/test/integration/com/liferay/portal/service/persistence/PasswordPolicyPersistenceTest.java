...
public class PasswordPolicyPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<PasswordPolicy> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_passwordPolicies.add(_persistence.update(newPasswordPolicy, false));
	...
	protected PasswordPolicy addPasswordPolicy() throws Exception {
		...
		_passwordPolicies.add(_persistence.update(passwordPolicy, false));
	...
	private ModelListener<PasswordPolicy>[] _listeners;
