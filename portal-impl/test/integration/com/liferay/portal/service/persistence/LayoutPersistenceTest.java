...
public class LayoutPersistenceTest {
	...
	public void setUp() {
		...
		for (ModelListener<Layout> modelListener : _listeners) {
	...
	public void testUpdateExisting() throws Exception {
		...
		_layouts.add(_persistence.update(newLayout, false));
	...
	protected Layout addLayout() throws Exception {
		...
		_layouts.add(_persistence.update(layout, false));
	...
	private ModelListener<Layout>[] _listeners;
